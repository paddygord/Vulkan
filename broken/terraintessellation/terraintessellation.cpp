...
public:
    ...
    void setupQueryResultBuffer() {
        ...
        queryResult= context.createBuffer(vk::BufferUsageFlagBits::eUniformBuffer | vk::BufferUsageFlagBits::eTransferDst, bufSize);
...
#define UV_SCALE 1.0f
    ...
    void setupDescriptorSetLayouts() {
        ...
        descriptorLayout = vk::DescriptorSetLayoutCreateInfo(setLayoutBindings.data(), static_cast<uint32_t>(setLayoutBindings.size()));
    ...
    void setupDescriptorSets() {
        ...
        // Terrain
        allocInfo = vk::DescriptorSetAllocateInfo(descriptorPool, &descriptorSetLayouts.terrain, 1);
        ...
        // Skysphere
        allocInfo = vk::DescriptorSetAllocateInfo(descriptorPool, &descriptorSetLayouts.skysphere, 1);
    ...
    void preparePipelines() {
        ...
        shaderStages[0] = context.loadShader(getAssetPath() + "shaders/terraintessellation/terrain.vert.spv", vk::ShaderStageFlagBits::eVertex);
        shaderStages[1] = context.loadShader(getAssetPath() + "shaders/terraintessellation/terrain.frag.spv", vk::ShaderStageFlagBits::eFragment);
        shaderStages[2] = context.loadShader(getAssetPath() + "shaders/terraintessellation/terrain.tesc.spv", vk::ShaderStageFlagBits::eTessellationControl);
        shaderStages[3] = context.loadShader(getAssetPath() + "shaders/terraintessellation/terrain.tese.spv", vk::ShaderStageFlagBits::eTessellationEvaluation);
        ...
        pipelines.terrain = device.createGraphicsPipelines(context.pipelineCache, pipelineCreateInfo)[0];

        // Terrain wireframe pipeline
        rasterizationState.polygonMode = vk::PolygonMode::eLine;
        pipelines.wireframe = device.createGraphicsPipelines(context.pipelineCache, pipelineCreateInfo)[0];
        ...
        shaderStages[0] = context.loadShader(getAssetPath() + "shaders/terraintessellation/skysphere.vert.spv", vk::ShaderStageFlagBits::eVertex);
        shaderStages[1] = context.loadShader(getAssetPath() + "shaders/terraintessellation/skysphere.frag.spv", vk::ShaderStageFlagBits::eFragment);
        pipelines.skysphere = device.createGraphicsPipelines(context.pipelineCache, pipelineCreateInfo)[0];
    }
