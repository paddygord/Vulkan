...
public:
    ...
    void setupDescriptorPool() {
        ...
        vk::DescriptorPoolCreateInfo descriptorPoolInfo =
            vk::DescriptorPoolCreateInfo(poolSizes.size(), poolSizes.data(), 3);
    ...
    void setupDescriptorSets() {
        ...
        vk::DescriptorImageInfo texDescriptor =
            vk::DescriptorImageInfo(shadowCubeMap.sampler, shadowCubeMap.view, vk::ImageLayout::eGeneral);
    ...
    void preparePipelines() {
        ...
        pipelines.scene = device.createGraphicsPipelines(context.pipelineCache, pipelineCreateInfo, nullptr)[0];
        ...
        pipelines.cubeMap = device.createGraphicsPipelines(context.pipelineCache, pipelineCreateInfo, nullptr)[0];
