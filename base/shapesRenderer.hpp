...
namespace vkx {
    ...
    public:
        ...
        ShapesRenderer(const vks::Context& context, bool stereo = false) : Parent(context), stereo(stereo) {
        ...
        void buildCommandBuffer() {
            ...
            context.setImageLayout(cmdBuffer, framebuffer.colors[0].image, vk::ImageAspectFlagBits::eColor, vk::ImageLayout::eUndefined, vk::ImageLayout::eColorAttachmentOptimal);
            context.setImageLayout(cmdBuffer, framebuffer.depth.image, vk::ImageAspectFlagBits::eDepth | vk::ImageAspectFlagBits::eStencil, vk::ImageLayout::eUndefined, vk::ImageLayout::eDepthStencilAttachmentOptimal);
        ...
        void setupDescriptorSetLayout() {
            ...
            std::vector<vk::DescriptorSetLayoutBinding> setLayoutBindings {
                { 0, uniformType, 1, vk::ShaderStageFlagBits::eVertex }
            };
        ...
        void render(
            const vk::ArrayProxy<const vks::Context::SemaphoreStagePair>& wait,
