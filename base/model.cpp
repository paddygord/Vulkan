...
void Model::loadFromFile(const vks::Context& context, const std::string& filename, const VertexLayout& layout, const ModelCreateInfo& createInfo, const int flags) {
    this->layout = layout;
