...
namespace vkx {
    ...
    public:
        ...
        void createContext(bool enableValidation) {
            ...
            if (enableValidation) {
                debug::setupDebugging(instance, (VkDebugReportFlagsEXT)(vk::DebugReportFlagBitsEXT::eError | vk::DebugReportFlagBitsEXT::eWarning), VK_NULL_HANDLE);
            }
        ...
        using CreateBufferResult = vkx::CreateBufferResult;
