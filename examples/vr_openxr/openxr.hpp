...
class ApiVersionUnsupportedError : public SystemError {
   public:
    ApiVersionUnsupportedError (std::string const& message)
        : SystemError(make_error_code(Result::ErrorApiVersionUnsupported), message){}
...
class InitializationFailedError : public SystemError {
   public:
    InitializationFailedError (std::string const& message)
        : SystemError(make_error_code(Result::ErrorInitializationFailed), message){}
...
class FunctionUnsupportedError : public SystemError {
   public:
    FunctionUnsupportedError (std::string const& message)
        : SystemError(make_error_code(Result::ErrorFunctionUnsupported), message){}
...
class ExtensionNotPresentError : public SystemError {
   public:
    ExtensionNotPresentError (std::string const& message)
        : SystemError(make_error_code(Result::ErrorExtensionNotPresent), message){}
...
class SwapchainRectInvalidError : public SystemError {
   public:
    SwapchainRectInvalidError (std::string const& message)
        : SystemError(make_error_code(Result::ErrorSwapchainRectInvalid), message){}
...
class SwapchainFormatUnsupportedError : public SystemError {
   public:
    SwapchainFormatUnsupportedError (std::string const& message)
        : SystemError(make_error_code(Result::ErrorSwapchainFormatUnsupported), message){}
...
class ReferenceSpaceUnsupportedError : public SystemError {
   public:
    ReferenceSpaceUnsupportedError (std::string const& message)
        : SystemError(make_error_code(Result::ErrorReferenceSpaceUnsupported), message){}
...
class FileContentsInvalidError : public SystemError {
   public:
    FileContentsInvalidError (std::string const& message)
        : SystemError(make_error_code(Result::ErrorFileContentsInvalid), message){}
...
class FormFactorUnsupportedError : public SystemError {
   public:
    FormFactorUnsupportedError (std::string const& message)
        : SystemError(make_error_code(Result::ErrorFormFactorUnsupported), message){}
...
class FormFactorUnavailableError : public SystemError {
   public:
    FormFactorUnavailableError (std::string const& message)
        : SystemError(make_error_code(Result::ErrorFormFactorUnavailable), message){}
...
class GraphicsDeviceInvalidError : public SystemError {
   public:
    GraphicsDeviceInvalidError (std::string const& message)
        : SystemError(make_error_code(Result::ErrorGraphicsDeviceInvalid), message){}
...
class ViewConfigurationTypeUnsupportedError : public SystemError {
   public:
    ViewConfigurationTypeUnsupportedError (std::string const& message)
        : SystemError(make_error_code(Result::ErrorViewConfigurationTypeUnsupported), message){}
...
class EnvironmentBlendModeUnsupportedError : public SystemError {
   public:
    EnvironmentBlendModeUnsupportedError (std::string const& message)
        : SystemError(make_error_code(Result::ErrorEnvironmentBlendModeUnsupported), message){}
...
class ActionsetNotAttachedError : public SystemError {
   public:
    ActionsetNotAttachedError (std::string const& message)
        : SystemError(make_error_code(Result::ErrorActionsetNotAttached), message){}
...
class ActionsetsAlreadyAttachedError : public SystemError {
   public:
    ActionsetsAlreadyAttachedError (std::string const& message)
        : SystemError(make_error_code(Result::ErrorActionsetsAlreadyAttached), message){}
...
class LocalizedNameDuplicatedError : public SystemError {
   public:
    LocalizedNameDuplicatedError (std::string const& message)
        : SystemError(make_error_code(Result::ErrorLocalizedNameDuplicated), message){}
...
class LocalizedNameInvalidError : public SystemError {
   public:
    LocalizedNameInvalidError (std::string const& message)
        : SystemError(make_error_code(Result::ErrorLocalizedNameInvalid), message){}
...
class AndroidThreadSettingsIdInvalidKHRError : public SystemError {
   public:
    AndroidThreadSettingsIdInvalidKHRError (std::string const& message)
        : SystemError(make_error_code(Result::ErrorAndroidThreadSettingsIdInvalidKHR), message){}
...
class AndroidThreadSettingsFailureKHRError : public SystemError {
   public:
    AndroidThreadSettingsFailureKHRError (std::string const& message)
        : SystemError(make_error_code(Result::ErrorAndroidThreadSettingsFailureKHR), message){}
...
class CreateSpatialAnchorFailedMSFTError : public SystemError {
   public:
    CreateSpatialAnchorFailedMSFTError (std::string const& message)
        : SystemError(make_error_code(Result::ErrorCreateSpatialAnchorFailedMSFT), message){}
...
class Instance {
   public:
    ...
    OPENXR_HPP_CONSTEXPR Instance(std::nullptr_t /* unused */) : m_raw(XR_NULL_HANDLE) {}
    ...
    OPENXR_HPP_CONSTEXPR RawHandleType *put() {
        m_raw = XR_NULL_HANDLE;
        return &m_raw;
    }
...
Result enumerateViewConfigurationViews (
    XrSystemId systemId, ViewConfigurationType viewConfigurationType, uint32_t viewCapacityInput, uint32_t* viewCountOutput, XrViewConfigurationView* views, Dispatch&& d = Dispatch{}) const;

#ifndef OPENXR_HPP_DISABLE_ENHANCED_MODE
    //! xrEnumerateViewConfigurationViews wrapper - enhanced mode
    template <typename Allocator = std::allocator<XrViewConfigurationView>, typename Dispatch = DispatchLoaderStatic>
    typename ResultValueType<std::vector<XrViewConfigurationView, Allocator>>::type enumerateViewConfigurationViews (
        XrSystemId systemId, ViewConfigurationType viewConfigurationType, Dispatch&& d = Dispatch{}) const;

//! xrEnumerateViewConfigurationViews wrapper - enhanced mode, stateful allocator
    template <typename Allocator = std::allocator<XrViewConfigurationView>, typename Dispatch = DispatchLoaderStatic>
    typename ResultValueType<std::vector<XrViewConfigurationView, Allocator>>::type enumerateViewConfigurationViews (
...
template <typename Dispatch = DispatchLoaderStatic>
Result pathToString (
    XrPath path, uint32_t bufferCapacityInput, uint32_t* bufferCountOutput, char* buffer, Dispatch&& d = Dispatch{}) const;
    ...
    typename ResultValueType<std::basic_string<char, std::char_traits<char>, Allocator>>::type pathToString (
        XrPath path, Dispatch&& d = Dispatch{}) const;

//! xrPathToString wrapper - enhanced mode, stateful allocator
    template <typename Allocator = std::allocator<char>, typename Dispatch = DispatchLoaderStatic>
    typename ResultValueType<std::basic_string<char, std::char_traits<char>, Allocator>>::type pathToString (
        XrPath path, Allocator const& vectorAllocator, Dispatch&& d) const;
...
Result getVulkanInstanceExtensionsKHR (
    XrSystemId systemId, uint32_t bufferCapacityInput, uint32_t* bufferCountOutput, char* buffer, Dispatch&& d) const;

#ifndef OPENXR_HPP_DISABLE_ENHANCED_MODE
    //! xrGetVulkanInstanceExtensionsKHR wrapper - enhanced mode
    template <typename Allocator = std::allocator<char>, typename Dispatch>
    typename ResultValueType<std::basic_string<char, std::char_traits<char>, Allocator>>::type getVulkanInstanceExtensionsKHR (
        XrSystemId systemId, Dispatch&& d) const;

//! xrGetVulkanInstanceExtensionsKHR wrapper - enhanced mode, stateful allocator
    template <typename Allocator = std::allocator<char>, typename Dispatch>
    typename ResultValueType<std::basic_string<char, std::char_traits<char>, Allocator>>::type getVulkanInstanceExtensionsKHR (
...
Result getVulkanDeviceExtensionsKHR (
    ...
    template <typename Allocator = std::allocator<char>, typename Dispatch>
    typename ResultValueType<std::basic_string<char, std::char_traits<char>, Allocator>>::type getVulkanDeviceExtensionsKHR (
        XrSystemId systemId, Dispatch&& d) const;
...
static_assert(sizeof(Instance) == sizeof(XrInstance), "handle and wrapper have different size!");

OPENXR_HPP_INLINE bool operator==(Instance const &lhs, Instance const &rhs) { return lhs.get() == rhs.get(); }
OPENXR_HPP_INLINE bool operator==(Instance const &lhs, XrInstance rhs) { return lhs.get() == rhs; }
OPENXR_HPP_INLINE bool operator==(XrInstance lhs, Instance const &rhs) { return rhs == lhs; }
OPENXR_HPP_INLINE bool operator==(Instance const &lhs, std::nullptr_t /* unused */) { return lhs.get() == XR_NULL_HANDLE; }
OPENXR_HPP_INLINE bool operator==(std::nullptr_t /* unused */, Instance const &rhs) { return rhs.get() == XR_NULL_HANDLE; }
OPENXR_HPP_INLINE bool operator!=(Instance const &lhs, Instance const &rhs) { return !(lhs == rhs); }
OPENXR_HPP_INLINE bool operator!=(Instance const &lhs, XrInstance rhs) { return !(lhs == rhs); }
OPENXR_HPP_INLINE bool operator!=(XrInstance lhs, Instance const &rhs) { return !(lhs == rhs); }
OPENXR_HPP_INLINE bool operator!=(Instance const &lhs, std::nullptr_t /* unused */) { return lhs.get() != XR_NULL_HANDLE; }
OPENXR_HPP_INLINE bool operator!=(std::nullptr_t /* unused */, Instance const &rhs) { return rhs.get() != XR_NULL_HANDLE; }

OPENXR_HPP_INLINE OPENXR_HPP_CONSTEXPR XrInstance get(Instance const &h) { return h.get(); }

OPENXR_HPP_INLINE OPENXR_HPP_CONSTEXPR XrInstance *put(Instance &h) { return h.put(); }
...
class Session {
   public:
    ...
    OPENXR_HPP_CONSTEXPR Session(std::nullptr_t /* unused */) : m_raw(XR_NULL_HANDLE) {}
...
Result enumerateReferenceSpaces (
    ...
    ResultValue<std::vector<ReferenceSpaceType, Allocator>> enumerateReferenceSpaces (
        Dispatch&& d = Dispatch{}) const;

//! xrEnumerateReferenceSpaces wrapper - enhanced mode, stateful allocator
    template <typename Allocator = std::allocator<ReferenceSpaceType>, typename Dispatch = DispatchLoaderStatic>
    ResultValue<std::vector<ReferenceSpaceType, Allocator>> enumerateReferenceSpaces (
...
Result enumerateSwapchainFormats (
    ...
    ResultValue<std::vector<int64_t, Allocator>> enumerateSwapchainFormats (
        Dispatch&& d = Dispatch{}) const;
...
Result locateViews (
    ...
    template <typename Allocator = std::allocator<XrView>, typename Dispatch = DispatchLoaderStatic>
    ResultValue<std::vector<XrView, Allocator>> locateViews (
        const XrViewLocateInfo* viewLocateInfo, XrViewState* viewState, Dispatch&& d = Dispatch{}) const;

//! xrLocateViews wrapper - enhanced mode, stateful allocator
    template <typename Allocator = std::allocator<XrView>, typename Dispatch = DispatchLoaderStatic>
    ResultValue<std::vector<XrView, Allocator>> locateViews (
...
Result enumerateBoundSourcesForAction (
    ...
    template <typename Allocator = std::allocator<XrPath>, typename Dispatch = DispatchLoaderStatic>
...
//! xrEnumerateBoundSourcesForAction wrapper - enhanced mode, stateful allocator
    template <typename Allocator = std::allocator<XrPath>, typename Dispatch = DispatchLoaderStatic>
    ResultValue<std::vector<XrPath, Allocator>> enumerateBoundSourcesForAction (
...
Result getInputSourceLocalizedName (
    ...
    template <typename Allocator = std::allocator<char>, typename Dispatch = DispatchLoaderStatic>
    ResultValue<std::basic_string<char, std::char_traits<char>, Allocator>> getInputSourceLocalizedName (
...
Result createSwapchainAndroidSurfaceKHR (
    ...
    template <typename Dispatch>
    ResultValue<jobject> createSwapchainAndroidSurfaceKHR (
    ...
    template <typename Dispatch>
    ResultValue<UniqueHandle<jobject, impl::RemoveRefConst<Dispatch>>> createSwapchainAndroidSurfaceUniqueKHR (
        const XrSwapchainCreateInfo* info, Swapchain& swapchain, Dispatch&& d) const;
#endif /*OPENXR_HPP_NO_SMART_HANDLE*/
#endif /*OPENXR_HPP_DISABLE_ENHANCED_MODE*/
...
static_assert(sizeof(Session) == sizeof(XrSession), "handle and wrapper have different size!");

OPENXR_HPP_INLINE bool operator==(Session const &lhs, Session const &rhs) { return lhs.get() == rhs.get(); }
OPENXR_HPP_INLINE bool operator==(Session const &lhs, XrSession rhs) { return lhs.get() == rhs; }
OPENXR_HPP_INLINE bool operator==(XrSession lhs, Session const &rhs) { return rhs == lhs; }
OPENXR_HPP_INLINE bool operator==(Session const &lhs, std::nullptr_t /* unused */) { return lhs.get() == XR_NULL_HANDLE; }
OPENXR_HPP_INLINE bool operator==(std::nullptr_t /* unused */, Session const &rhs) { return rhs.get() == XR_NULL_HANDLE; }
OPENXR_HPP_INLINE bool operator!=(Session const &lhs, Session const &rhs) { return !(lhs == rhs); }
OPENXR_HPP_INLINE bool operator!=(Session const &lhs, XrSession rhs) { return !(lhs == rhs); }
OPENXR_HPP_INLINE bool operator!=(XrSession lhs, Session const &rhs) { return !(lhs == rhs); }
OPENXR_HPP_INLINE bool operator!=(Session const &lhs, std::nullptr_t /* unused */) { return lhs.get() != XR_NULL_HANDLE; }
OPENXR_HPP_INLINE bool operator!=(std::nullptr_t /* unused */, Session const &rhs) { return rhs.get() != XR_NULL_HANDLE; }

OPENXR_HPP_INLINE OPENXR_HPP_CONSTEXPR XrSession get(Session const &h) { return h.get(); }

OPENXR_HPP_INLINE OPENXR_HPP_CONSTEXPR XrSession *put(Session &h) { return h.put(); }
...
class Space {
   public:
    ...
    OPENXR_HPP_CONSTEXPR Space(std::nullptr_t /* unused */) : m_raw(XR_NULL_HANDLE) {}
...
static_assert(sizeof(Space) == sizeof(XrSpace), "handle and wrapper have different size!");

OPENXR_HPP_INLINE bool operator==(Space const &lhs, Space const &rhs) { return lhs.get() == rhs.get(); }
OPENXR_HPP_INLINE bool operator==(Space const &lhs, XrSpace rhs) { return lhs.get() == rhs; }
OPENXR_HPP_INLINE bool operator==(XrSpace lhs, Space const &rhs) { return rhs == lhs; }
OPENXR_HPP_INLINE bool operator==(Space const &lhs, std::nullptr_t /* unused */) { return lhs.get() == XR_NULL_HANDLE; }
OPENXR_HPP_INLINE bool operator==(std::nullptr_t /* unused */, Space const &rhs) { return rhs.get() == XR_NULL_HANDLE; }
OPENXR_HPP_INLINE bool operator!=(Space const &lhs, Space const &rhs) { return !(lhs == rhs); }
OPENXR_HPP_INLINE bool operator!=(Space const &lhs, XrSpace rhs) { return !(lhs == rhs); }
OPENXR_HPP_INLINE bool operator!=(XrSpace lhs, Space const &rhs) { return !(lhs == rhs); }
OPENXR_HPP_INLINE bool operator!=(Space const &lhs, std::nullptr_t /* unused */) { return lhs.get() != XR_NULL_HANDLE; }
OPENXR_HPP_INLINE bool operator!=(std::nullptr_t /* unused */, Space const &rhs) { return rhs.get() != XR_NULL_HANDLE; }

OPENXR_HPP_INLINE OPENXR_HPP_CONSTEXPR XrSpace get(Space const &h) { return h.get(); }

OPENXR_HPP_INLINE OPENXR_HPP_CONSTEXPR XrSpace *put(Space &h) { return h.put(); }
...
class Action {
   public:
    ...
    OPENXR_HPP_CONSTEXPR Action(std::nullptr_t /* unused */) : m_raw(XR_NULL_HANDLE) {}
...
static_assert(sizeof(Action) == sizeof(XrAction), "handle and wrapper have different size!");

OPENXR_HPP_INLINE bool operator==(Action const &lhs, Action const &rhs) { return lhs.get() == rhs.get(); }
OPENXR_HPP_INLINE bool operator==(Action const &lhs, XrAction rhs) { return lhs.get() == rhs; }
OPENXR_HPP_INLINE bool operator==(XrAction lhs, Action const &rhs) { return rhs == lhs; }
OPENXR_HPP_INLINE bool operator==(Action const &lhs, std::nullptr_t /* unused */) { return lhs.get() == XR_NULL_HANDLE; }
OPENXR_HPP_INLINE bool operator==(std::nullptr_t /* unused */, Action const &rhs) { return rhs.get() == XR_NULL_HANDLE; }
OPENXR_HPP_INLINE bool operator!=(Action const &lhs, Action const &rhs) { return !(lhs == rhs); }
OPENXR_HPP_INLINE bool operator!=(Action const &lhs, XrAction rhs) { return !(lhs == rhs); }
OPENXR_HPP_INLINE bool operator!=(XrAction lhs, Action const &rhs) { return !(lhs == rhs); }
OPENXR_HPP_INLINE bool operator!=(Action const &lhs, std::nullptr_t /* unused */) { return lhs.get() != XR_NULL_HANDLE; }
OPENXR_HPP_INLINE bool operator!=(std::nullptr_t /* unused */, Action const &rhs) { return rhs.get() != XR_NULL_HANDLE; }

OPENXR_HPP_INLINE OPENXR_HPP_CONSTEXPR XrAction get(Action const &h) { return h.get(); }

OPENXR_HPP_INLINE OPENXR_HPP_CONSTEXPR XrAction *put(Action &h) { return h.put(); }
...
class Swapchain {
   public:
    ...
    OPENXR_HPP_CONSTEXPR Swapchain(std::nullptr_t /* unused */) : m_raw(XR_NULL_HANDLE) {}

    OPENXR_HPP_TYPESAFE_EXPLICIT Swapchain(RawHandleType handle) : m_raw(handle) {}
...
static_assert(sizeof(Swapchain) == sizeof(XrSwapchain), "handle and wrapper have different size!");

OPENXR_HPP_INLINE bool operator==(Swapchain const &lhs, Swapchain const &rhs) { return lhs.get() == rhs.get(); }
OPENXR_HPP_INLINE bool operator==(Swapchain const &lhs, XrSwapchain rhs) { return lhs.get() == rhs; }
OPENXR_HPP_INLINE bool operator==(XrSwapchain lhs, Swapchain const &rhs) { return rhs == lhs; }
OPENXR_HPP_INLINE bool operator==(Swapchain const &lhs, std::nullptr_t /* unused */) { return lhs.get() == XR_NULL_HANDLE; }
OPENXR_HPP_INLINE bool operator==(std::nullptr_t /* unused */, Swapchain const &rhs) { return rhs.get() == XR_NULL_HANDLE; }
OPENXR_HPP_INLINE bool operator!=(Swapchain const &lhs, Swapchain const &rhs) { return !(lhs == rhs); }
OPENXR_HPP_INLINE bool operator!=(Swapchain const &lhs, XrSwapchain rhs) { return !(lhs == rhs); }
OPENXR_HPP_INLINE bool operator!=(XrSwapchain lhs, Swapchain const &rhs) { return !(lhs == rhs); }
OPENXR_HPP_INLINE bool operator!=(Swapchain const &lhs, std::nullptr_t /* unused */) { return lhs.get() != XR_NULL_HANDLE; }
OPENXR_HPP_INLINE bool operator!=(std::nullptr_t /* unused */, Swapchain const &rhs) { return rhs.get() != XR_NULL_HANDLE; }

OPENXR_HPP_INLINE OPENXR_HPP_CONSTEXPR XrSwapchain get(Swapchain const &h) { return h.get(); }

OPENXR_HPP_INLINE OPENXR_HPP_CONSTEXPR XrSwapchain *put(Swapchain &h) { return h.put(); }
...
class ActionSet {
   public:
    ...
    OPENXR_HPP_CONSTEXPR ActionSet(std::nullptr_t /* unused */) : m_raw(XR_NULL_HANDLE) {}

    OPENXR_HPP_TYPESAFE_EXPLICIT ActionSet(RawHandleType handle) : m_raw(handle) {}
...
static_assert(sizeof(ActionSet) == sizeof(XrActionSet), "handle and wrapper have different size!");

OPENXR_HPP_INLINE bool operator==(ActionSet const &lhs, ActionSet const &rhs) { return lhs.get() == rhs.get(); }
OPENXR_HPP_INLINE bool operator==(ActionSet const &lhs, XrActionSet rhs) { return lhs.get() == rhs; }
OPENXR_HPP_INLINE bool operator==(XrActionSet lhs, ActionSet const &rhs) { return rhs == lhs; }
OPENXR_HPP_INLINE bool operator==(ActionSet const &lhs, std::nullptr_t /* unused */) { return lhs.get() == XR_NULL_HANDLE; }
OPENXR_HPP_INLINE bool operator==(std::nullptr_t /* unused */, ActionSet const &rhs) { return rhs.get() == XR_NULL_HANDLE; }
OPENXR_HPP_INLINE bool operator!=(ActionSet const &lhs, ActionSet const &rhs) { return !(lhs == rhs); }
OPENXR_HPP_INLINE bool operator!=(ActionSet const &lhs, XrActionSet rhs) { return !(lhs == rhs); }
OPENXR_HPP_INLINE bool operator!=(XrActionSet lhs, ActionSet const &rhs) { return !(lhs == rhs); }
OPENXR_HPP_INLINE bool operator!=(ActionSet const &lhs, std::nullptr_t /* unused */) { return lhs.get() != XR_NULL_HANDLE; }
OPENXR_HPP_INLINE bool operator!=(std::nullptr_t /* unused */, ActionSet const &rhs) { return rhs.get() != XR_NULL_HANDLE; }

OPENXR_HPP_INLINE OPENXR_HPP_CONSTEXPR XrActionSet get(ActionSet const &h) { return h.get(); }

OPENXR_HPP_INLINE OPENXR_HPP_CONSTEXPR XrActionSet *put(ActionSet &h) { return h.put(); }
...
class DebugUtilsMessengerEXT {
   public:
    ...
    OPENXR_HPP_CONSTEXPR DebugUtilsMessengerEXT(std::nullptr_t /* unused */) : m_raw(XR_NULL_HANDLE) {}

    OPENXR_HPP_TYPESAFE_EXPLICIT DebugUtilsMessengerEXT(RawHandleType handle) : m_raw(handle) {}
...
static_assert(sizeof(DebugUtilsMessengerEXT) == sizeof(XrDebugUtilsMessengerEXT), "handle and wrapper have different size!");

OPENXR_HPP_INLINE bool operator==(DebugUtilsMessengerEXT const &lhs, DebugUtilsMessengerEXT const &rhs) { return lhs.get() == rhs.get(); }
OPENXR_HPP_INLINE bool operator==(DebugUtilsMessengerEXT const &lhs, XrDebugUtilsMessengerEXT rhs) { return lhs.get() == rhs; }
OPENXR_HPP_INLINE bool operator==(XrDebugUtilsMessengerEXT lhs, DebugUtilsMessengerEXT const &rhs) { return rhs == lhs; }
OPENXR_HPP_INLINE bool operator==(DebugUtilsMessengerEXT const &lhs, std::nullptr_t /* unused */) { return lhs.get() == XR_NULL_HANDLE; }
OPENXR_HPP_INLINE bool operator==(std::nullptr_t /* unused */, DebugUtilsMessengerEXT const &rhs) { return rhs.get() == XR_NULL_HANDLE; }
OPENXR_HPP_INLINE bool operator!=(DebugUtilsMessengerEXT const &lhs, DebugUtilsMessengerEXT const &rhs) { return !(lhs == rhs); }
OPENXR_HPP_INLINE bool operator!=(DebugUtilsMessengerEXT const &lhs, XrDebugUtilsMessengerEXT rhs) { return !(lhs == rhs); }
OPENXR_HPP_INLINE bool operator!=(XrDebugUtilsMessengerEXT lhs, DebugUtilsMessengerEXT const &rhs) { return !(lhs == rhs); }
OPENXR_HPP_INLINE bool operator!=(DebugUtilsMessengerEXT const &lhs, std::nullptr_t /* unused */) { return lhs.get() != XR_NULL_HANDLE; }
OPENXR_HPP_INLINE bool operator!=(std::nullptr_t /* unused */, DebugUtilsMessengerEXT const &rhs) { return rhs.get() != XR_NULL_HANDLE; }

OPENXR_HPP_INLINE OPENXR_HPP_CONSTEXPR XrDebugUtilsMessengerEXT get(DebugUtilsMessengerEXT const &h) { return h.get(); }

OPENXR_HPP_INLINE OPENXR_HPP_CONSTEXPR XrDebugUtilsMessengerEXT *put(DebugUtilsMessengerEXT &h) { return h.put(); }
...
class SpatialAnchorMSFT {
   public:
    ...
    OPENXR_HPP_CONSTEXPR SpatialAnchorMSFT(std::nullptr_t /* unused */) : m_raw(XR_NULL_HANDLE) {}

    OPENXR_HPP_TYPESAFE_EXPLICIT SpatialAnchorMSFT(RawHandleType handle) : m_raw(handle) {}
...
static_assert(sizeof(SpatialAnchorMSFT) == sizeof(XrSpatialAnchorMSFT), "handle and wrapper have different size!");

OPENXR_HPP_INLINE bool operator==(SpatialAnchorMSFT const &lhs, SpatialAnchorMSFT const &rhs) { return lhs.get() == rhs.get(); }
OPENXR_HPP_INLINE bool operator==(SpatialAnchorMSFT const &lhs, XrSpatialAnchorMSFT rhs) { return lhs.get() == rhs; }
OPENXR_HPP_INLINE bool operator==(XrSpatialAnchorMSFT lhs, SpatialAnchorMSFT const &rhs) { return rhs == lhs; }
OPENXR_HPP_INLINE bool operator==(SpatialAnchorMSFT const &lhs, std::nullptr_t /* unused */) { return lhs.get() == XR_NULL_HANDLE; }
OPENXR_HPP_INLINE bool operator==(std::nullptr_t /* unused */, SpatialAnchorMSFT const &rhs) { return rhs.get() == XR_NULL_HANDLE; }
OPENXR_HPP_INLINE bool operator!=(SpatialAnchorMSFT const &lhs, SpatialAnchorMSFT const &rhs) { return !(lhs == rhs); }
OPENXR_HPP_INLINE bool operator!=(SpatialAnchorMSFT const &lhs, XrSpatialAnchorMSFT rhs) { return !(lhs == rhs); }
OPENXR_HPP_INLINE bool operator!=(XrSpatialAnchorMSFT lhs, SpatialAnchorMSFT const &rhs) { return !(lhs == rhs); }
OPENXR_HPP_INLINE bool operator!=(SpatialAnchorMSFT const &lhs, std::nullptr_t /* unused */) { return lhs.get() != XR_NULL_HANDLE; }
OPENXR_HPP_INLINE bool operator!=(std::nullptr_t /* unused */, SpatialAnchorMSFT const &rhs) { return rhs.get() != XR_NULL_HANDLE; }

OPENXR_HPP_INLINE OPENXR_HPP_CONSTEXPR XrSpatialAnchorMSFT get(SpatialAnchorMSFT const &h) { return h.get(); }

OPENXR_HPP_INLINE OPENXR_HPP_CONSTEXPR XrSpatialAnchorMSFT *put(SpatialAnchorMSFT &h) { return h.put(); }
...
Result enumerateApiLayerProperties (
    ...
    template <typename Allocator = std::allocator<XrApiLayerProperties>, typename Dispatch = DispatchLoaderStatic>
    typename ResultValueType<std::vector<XrApiLayerProperties, Allocator>>::type enumerateApiLayerProperties (
        Dispatch&& d = Dispatch{}) ;
...
Result enumerateInstanceExtensionProperties (
    ...
    template <typename Allocator = std::allocator<XrExtensionProperties>, typename Dispatch = DispatchLoaderStatic>
    typename ResultValueType<std::vector<XrExtensionProperties, Allocator>>::type enumerateInstanceExtensionProperties (
        const char* layerName, Dispatch&& d = Dispatch{}) ;

//! xrEnumerateInstanceExtensionProperties wrapper - enhanced mode, stateful allocator
    template <typename Allocator = std::allocator<XrExtensionProperties>, typename Dispatch = DispatchLoaderStatic>
    typename ResultValueType<std::vector<XrExtensionProperties, Allocator>>::type enumerateInstanceExtensionProperties (
...
class DispatchLoaderDynamic {
   public:
    ...
    //! Call xrGetInstanceProcAddr (const overload - does not populate function pointer)
    XrResult xrGetInstanceProcAddr( XrInstance instance, const char* name, PFN_xrVoidFunction* function) const {
        return (reinterpret_cast<PFN_xrGetInstanceProcAddr>(pfnGetInstanceProcAddr))(
             instance, name, function );
    }
    ...
    //! Call xrEnumerateApiLayerProperties, populating function pointer if required.
    ...
    //! Call xrEnumerateApiLayerProperties (const overload - does not populate function pointer)
    XrResult xrEnumerateApiLayerProperties( uint32_t propertyCapacityInput, uint32_t* propertyCountOutput, XrApiLayerProperties* properties) const {
        return (reinterpret_cast<PFN_xrEnumerateApiLayerProperties>(pfnEnumerateApiLayerProperties))(
             propertyCapacityInput, propertyCountOutput, properties );
    }
    ...
    //! Call xrEnumerateInstanceExtensionProperties, populating function pointer if required.
    ...
    //! Call xrEnumerateInstanceExtensionProperties (const overload - does not populate function pointer)
    XrResult xrEnumerateInstanceExtensionProperties( const char* layerName, uint32_t propertyCapacityInput, uint32_t* propertyCountOutput, XrExtensionProperties* properties) const {
        return (reinterpret_cast<PFN_xrEnumerateInstanceExtensionProperties>(pfnEnumerateInstanceExtensionProperties))(
             layerName, propertyCapacityInput, propertyCountOutput, properties );
    }
    ...
    //! Call xrCreateInstance (const overload - does not populate function pointer)
    XrResult xrCreateInstance( const XrInstanceCreateInfo* createInfo, XrInstance* instance) const {
        return (reinterpret_cast<PFN_xrCreateInstance>(pfnCreateInstance))(
             createInfo, instance );
    }
    ...
    //! Call xrDestroyInstance (const overload - does not populate function pointer)
    XrResult xrDestroyInstance( XrInstance instance) const {
        return (reinterpret_cast<PFN_xrDestroyInstance>(pfnDestroyInstance))(
             instance );
    }
    ...
    //! Call xrGetInstanceProperties (const overload - does not populate function pointer)
    XrResult xrGetInstanceProperties( XrInstance instance, XrInstanceProperties* instanceProperties) const {
        return (reinterpret_cast<PFN_xrGetInstanceProperties>(pfnGetInstanceProperties))(
             instance, instanceProperties );
    }
    ...
    //! Call xrResultToString (const overload - does not populate function pointer)
    XrResult xrResultToString( XrInstance instance, XrResult value, char buffer[XR_MAX_RESULT_STRING_SIZE]) const {
        return (reinterpret_cast<PFN_xrResultToString>(pfnResultToString))(
             instance, value, buffer );
    }
    ...
    //! Call xrStructureTypeToString (const overload - does not populate function pointer)
    XrResult xrStructureTypeToString( XrInstance instance, XrStructureType value, char buffer[XR_MAX_STRUCTURE_NAME_SIZE]) const {
        return (reinterpret_cast<PFN_xrStructureTypeToString>(pfnStructureTypeToString))(
             instance, value, buffer );
    }
    ...
    //! Call xrGetSystemProperties (const overload - does not populate function pointer)
    XrResult xrGetSystemProperties( XrInstance instance, XrSystemId systemId, XrSystemProperties* properties) const {
        return (reinterpret_cast<PFN_xrGetSystemProperties>(pfnGetSystemProperties))(
             instance, systemId, properties );
    }
    ...
    //! Call xrEnumerateEnvironmentBlendModes, populating function pointer if required.
    ...
    //! Call xrEnumerateEnvironmentBlendModes (const overload - does not populate function pointer)
    XrResult xrEnumerateEnvironmentBlendModes( XrInstance instance, XrSystemId systemId, XrViewConfigurationType viewConfigurationType, uint32_t environmentBlendModeCapacityInput, uint32_t* environmentBlendModeCountOutput, XrEnvironmentBlendMode* environmentBlendModes) const {
        return (reinterpret_cast<PFN_xrEnumerateEnvironmentBlendModes>(pfnEnumerateEnvironmentBlendModes))(
             instance, systemId, viewConfigurationType, environmentBlendModeCapacityInput, environmentBlendModeCountOutput, environmentBlendModes );
    }
    ...
    //! Call xrDestroySession (const overload - does not populate function pointer)
    XrResult xrDestroySession( XrSession session) const {
        return (reinterpret_cast<PFN_xrDestroySession>(pfnDestroySession))(
             session );
    }
    ...
    //! Call xrEnumerateReferenceSpaces (const overload - does not populate function pointer)
    XrResult xrEnumerateReferenceSpaces( XrSession session, uint32_t spaceCapacityInput, uint32_t* spaceCountOutput, XrReferenceSpaceType* spaces) const {
        return (reinterpret_cast<PFN_xrEnumerateReferenceSpaces>(pfnEnumerateReferenceSpaces))(
             session, spaceCapacityInput, spaceCountOutput, spaces );
    }
    ...
    //! Call xrCreateReferenceSpace (const overload - does not populate function pointer)
    XrResult xrCreateReferenceSpace( XrSession session, const XrReferenceSpaceCreateInfo* createInfo, XrSpace* space) const {
        return (reinterpret_cast<PFN_xrCreateReferenceSpace>(pfnCreateReferenceSpace))(
             session, createInfo, space );
    }
    ...
    //! Call xrGetReferenceSpaceBoundsRect, populating function pointer if required.
    ...
    //! Call xrGetReferenceSpaceBoundsRect (const overload - does not populate function pointer)
    XrResult xrGetReferenceSpaceBoundsRect( XrSession session, XrReferenceSpaceType referenceSpaceType, XrExtent2Df* bounds) const {
        return (reinterpret_cast<PFN_xrGetReferenceSpaceBoundsRect>(pfnGetReferenceSpaceBoundsRect))(
             session, referenceSpaceType, bounds );
    }
    ...
    //! Call xrCreateActionSpace (const overload - does not populate function pointer)
    XrResult xrCreateActionSpace( XrSession session, const XrActionSpaceCreateInfo* createInfo, XrSpace* space) const {
        return (reinterpret_cast<PFN_xrCreateActionSpace>(pfnCreateActionSpace))(
             session, createInfo, space );
    }
    ...
    //! Call xrEnumerateViewConfigurations, populating function pointer if required.
    ...
    //! Call xrEnumerateViewConfigurations (const overload - does not populate function pointer)
    XrResult xrEnumerateViewConfigurations( XrInstance instance, XrSystemId systemId, uint32_t viewConfigurationTypeCapacityInput, uint32_t* viewConfigurationTypeCountOutput, XrViewConfigurationType* viewConfigurationTypes) const {
        return (reinterpret_cast<PFN_xrEnumerateViewConfigurations>(pfnEnumerateViewConfigurations))(
             instance, systemId, viewConfigurationTypeCapacityInput, viewConfigurationTypeCountOutput, viewConfigurationTypes );
    }
    ...
    //! Call xrGetViewConfigurationProperties, populating function pointer if required.
    ...
    //! Call xrGetViewConfigurationProperties (const overload - does not populate function pointer)
    XrResult xrGetViewConfigurationProperties( XrInstance instance, XrSystemId systemId, XrViewConfigurationType viewConfigurationType, XrViewConfigurationProperties* configurationProperties) const {
        return (reinterpret_cast<PFN_xrGetViewConfigurationProperties>(pfnGetViewConfigurationProperties))(
             instance, systemId, viewConfigurationType, configurationProperties );
    }
    ...
    //! Call xrEnumerateViewConfigurationViews, populating function pointer if required.
    ...
    //! Call xrEnumerateViewConfigurationViews (const overload - does not populate function pointer)
    XrResult xrEnumerateViewConfigurationViews( XrInstance instance, XrSystemId systemId, XrViewConfigurationType viewConfigurationType, uint32_t viewCapacityInput, uint32_t* viewCountOutput, XrViewConfigurationView* views) const {
        return (reinterpret_cast<PFN_xrEnumerateViewConfigurationViews>(pfnEnumerateViewConfigurationViews))(
             instance, systemId, viewConfigurationType, viewCapacityInput, viewCountOutput, views );
    }
    ...
    //! Call xrEnumerateSwapchainFormats (const overload - does not populate function pointer)
    XrResult xrEnumerateSwapchainFormats( XrSession session, uint32_t formatCapacityInput, uint32_t* formatCountOutput, int64_t* formats) const {
        return (reinterpret_cast<PFN_xrEnumerateSwapchainFormats>(pfnEnumerateSwapchainFormats))(
             session, formatCapacityInput, formatCountOutput, formats );
    }
    ...
    //! Call xrCreateSwapchain (const overload - does not populate function pointer)
    XrResult xrCreateSwapchain( XrSession session, const XrSwapchainCreateInfo* createInfo, XrSwapchain* swapchain) const {
        return (reinterpret_cast<PFN_xrCreateSwapchain>(pfnCreateSwapchain))(
             session, createInfo, swapchain );
    }
    ...
    //! Call xrDestroySwapchain (const overload - does not populate function pointer)
    XrResult xrDestroySwapchain( XrSwapchain swapchain) const {
        return (reinterpret_cast<PFN_xrDestroySwapchain>(pfnDestroySwapchain))(
             swapchain );
    }
    ...
    //! Call xrEnumerateSwapchainImages (const overload - does not populate function pointer)
    XrResult xrEnumerateSwapchainImages( XrSwapchain swapchain, uint32_t imageCapacityInput, uint32_t* imageCountOutput, XrSwapchainImageBaseHeader* images) const {
        return (reinterpret_cast<PFN_xrEnumerateSwapchainImages>(pfnEnumerateSwapchainImages))(
             swapchain, imageCapacityInput, imageCountOutput, images );
    }
    ...
    //! Call xrAcquireSwapchainImage (const overload - does not populate function pointer)
    XrResult xrAcquireSwapchainImage( XrSwapchain swapchain, const XrSwapchainImageAcquireInfo* acquireInfo, uint32_t* index) const {
        return (reinterpret_cast<PFN_xrAcquireSwapchainImage>(pfnAcquireSwapchainImage))(
             swapchain, acquireInfo, index );
    }
    ...
    //! Call xrWaitSwapchainImage (const overload - does not populate function pointer)
    XrResult xrWaitSwapchainImage( XrSwapchain swapchain, const XrSwapchainImageWaitInfo* waitInfo) const {
        return (reinterpret_cast<PFN_xrWaitSwapchainImage>(pfnWaitSwapchainImage))(
             swapchain, waitInfo );
    }
    ...
    //! Call xrReleaseSwapchainImage (const overload - does not populate function pointer)
    XrResult xrReleaseSwapchainImage( XrSwapchain swapchain, const XrSwapchainImageReleaseInfo* releaseInfo) const {
        return (reinterpret_cast<PFN_xrReleaseSwapchainImage>(pfnReleaseSwapchainImage))(
             swapchain, releaseInfo );
    }
    ...
    //! Call xrRequestExitSession (const overload - does not populate function pointer)
    XrResult xrRequestExitSession( XrSession session) const {
        return (reinterpret_cast<PFN_xrRequestExitSession>(pfnRequestExitSession))(
             session );
    }
    ...
    //! Call xrCreateActionSet (const overload - does not populate function pointer)
    XrResult xrCreateActionSet( XrInstance instance, const XrActionSetCreateInfo* createInfo, XrActionSet* actionSet) const {
        return (reinterpret_cast<PFN_xrCreateActionSet>(pfnCreateActionSet))(
             instance, createInfo, actionSet );
    }
    ...
    //! Call xrDestroyActionSet (const overload - does not populate function pointer)
    XrResult xrDestroyActionSet( XrActionSet actionSet) const {
        return (reinterpret_cast<PFN_xrDestroyActionSet>(pfnDestroyActionSet))(
             actionSet );
    }
    ...
    //! Call xrSuggestInteractionProfileBindings, populating function pointer if required.
    ...
    //! Call xrSuggestInteractionProfileBindings (const overload - does not populate function pointer)
    XrResult xrSuggestInteractionProfileBindings( XrInstance instance, const XrInteractionProfileSuggestedBinding* suggestedBindings) const {
        return (reinterpret_cast<PFN_xrSuggestInteractionProfileBindings>(pfnSuggestInteractionProfileBindings))(
             instance, suggestedBindings );
    }
    ...
    //! Call xrAttachSessionActionSets (const overload - does not populate function pointer)
    XrResult xrAttachSessionActionSets( XrSession session, const XrSessionActionSetsAttachInfo* attachInfo) const {
        return (reinterpret_cast<PFN_xrAttachSessionActionSets>(pfnAttachSessionActionSets))(
             session, attachInfo );
    }
    ...
    //! Call xrGetCurrentInteractionProfile, populating function pointer if required.
    ...
    //! Call xrGetCurrentInteractionProfile (const overload - does not populate function pointer)
    XrResult xrGetCurrentInteractionProfile( XrSession session, XrPath topLevelUserPath, XrInteractionProfileState* interactionProfile) const {
        return (reinterpret_cast<PFN_xrGetCurrentInteractionProfile>(pfnGetCurrentInteractionProfile))(
             session, topLevelUserPath, interactionProfile );
    }
    ...
    //! Call xrGetActionStateBoolean (const overload - does not populate function pointer)
    XrResult xrGetActionStateBoolean( XrSession session, const XrActionStateGetInfo* getInfo, XrActionStateBoolean* state) const {
        return (reinterpret_cast<PFN_xrGetActionStateBoolean>(pfnGetActionStateBoolean))(
             session, getInfo, state );
    }
    ...
    //! Call xrGetActionStateFloat (const overload - does not populate function pointer)
    XrResult xrGetActionStateFloat( XrSession session, const XrActionStateGetInfo* getInfo, XrActionStateFloat* state) const {
        return (reinterpret_cast<PFN_xrGetActionStateFloat>(pfnGetActionStateFloat))(
             session, getInfo, state );
    }
    ...
    //! Call xrGetActionStateVector2f (const overload - does not populate function pointer)
    XrResult xrGetActionStateVector2f( XrSession session, const XrActionStateGetInfo* getInfo, XrActionStateVector2f* state) const {
        return (reinterpret_cast<PFN_xrGetActionStateVector2f>(pfnGetActionStateVector2f))(
             session, getInfo, state );
    }
    ...
    //! Call xrGetActionStatePose (const overload - does not populate function pointer)
    XrResult xrGetActionStatePose( XrSession session, const XrActionStateGetInfo* getInfo, XrActionStatePose* state) const {
        return (reinterpret_cast<PFN_xrGetActionStatePose>(pfnGetActionStatePose))(
             session, getInfo, state );
    }
    ...
    //! Call xrEnumerateBoundSourcesForAction, populating function pointer if required.
    ...
    //! Call xrEnumerateBoundSourcesForAction (const overload - does not populate function pointer)
    XrResult xrEnumerateBoundSourcesForAction( XrSession session, const XrBoundSourcesForActionEnumerateInfo* enumerateInfo, uint32_t sourceCapacityInput, uint32_t* sourceCountOutput, XrPath* sources) const {
        return (reinterpret_cast<PFN_xrEnumerateBoundSourcesForAction>(pfnEnumerateBoundSourcesForAction))(
             session, enumerateInfo, sourceCapacityInput, sourceCountOutput, sources );
    }
    ...
    //! Call xrGetInputSourceLocalizedName, populating function pointer if required.
    ...
    //! Call xrGetInputSourceLocalizedName (const overload - does not populate function pointer)
    XrResult xrGetInputSourceLocalizedName( XrSession session, const XrInputSourceLocalizedNameGetInfo* getInfo, uint32_t bufferCapacityInput, uint32_t* bufferCountOutput, char* buffer) const {
        return (reinterpret_cast<PFN_xrGetInputSourceLocalizedName>(pfnGetInputSourceLocalizedName))(
             session, getInfo, bufferCapacityInput, bufferCountOutput, buffer );
    }
    ...
    //! Call xrApplyHapticFeedback (const overload - does not populate function pointer)
    XrResult xrApplyHapticFeedback( XrSession session, const XrHapticActionInfo* hapticActionInfo, const XrHapticBaseHeader* hapticFeedback) const {
        return (reinterpret_cast<PFN_xrApplyHapticFeedback>(pfnApplyHapticFeedback))(
             session, hapticActionInfo, hapticFeedback );
    }
    ...
    //! Call xrStopHapticFeedback (const overload - does not populate function pointer)
    XrResult xrStopHapticFeedback( XrSession session, const XrHapticActionInfo* hapticActionInfo) const {
        return (reinterpret_cast<PFN_xrStopHapticFeedback>(pfnStopHapticFeedback))(
             session, hapticActionInfo );
    }
    ...
    #if defined(XR_USE_PLATFORM_ANDROID)
    //! Call xrSetAndroidApplicationThreadKHR, populating function pointer if required.
    ...
    //! Call xrSetAndroidApplicationThreadKHR (const overload - does not populate function pointer)
    ...
    #endif // defined(XR_USE_PLATFORM_ANDROID)
    #if defined(XR_USE_PLATFORM_ANDROID)
    //! Call xrCreateSwapchainAndroidSurfaceKHR, populating function pointer if required.
    ...
    //! Call xrCreateSwapchainAndroidSurfaceKHR (const overload - does not populate function pointer)
    ...
    #endif // defined(XR_USE_PLATFORM_ANDROID)
    #if defined(XR_USE_GRAPHICS_API_OPENGL)
    //! Call xrGetOpenGLGraphicsRequirementsKHR, populating function pointer if required.
    ...
    //! Call xrGetOpenGLGraphicsRequirementsKHR (const overload - does not populate function pointer)
    ...
    #endif // defined(XR_USE_GRAPHICS_API_OPENGL)
    #if defined(XR_USE_GRAPHICS_API_OPENGL_ES)
    //! Call xrGetOpenGLESGraphicsRequirementsKHR, populating function pointer if required.
    ...
    //! Call xrGetOpenGLESGraphicsRequirementsKHR (const overload - does not populate function pointer)
    ...
    #endif // defined(XR_USE_GRAPHICS_API_OPENGL_ES)
    #if defined(XR_USE_GRAPHICS_API_VULKAN)
    //! Call xrGetVulkanInstanceExtensionsKHR, populating function pointer if required.
    ...
    //! Call xrGetVulkanInstanceExtensionsKHR (const overload - does not populate function pointer)
    ...
    #endif // defined(XR_USE_GRAPHICS_API_VULKAN)
    #if defined(XR_USE_GRAPHICS_API_VULKAN)
    //! Call xrGetVulkanDeviceExtensionsKHR, populating function pointer if required.
    ...
    //! Call xrGetVulkanDeviceExtensionsKHR (const overload - does not populate function pointer)
    ...
    #endif // defined(XR_USE_GRAPHICS_API_VULKAN)
    #if defined(XR_USE_GRAPHICS_API_VULKAN)
    //! Call xrGetVulkanGraphicsDeviceKHR, populating function pointer if required.
    ...
    //! Call xrGetVulkanGraphicsDeviceKHR (const overload - does not populate function pointer)
    ...
    #endif // defined(XR_USE_GRAPHICS_API_VULKAN)
    #if defined(XR_USE_GRAPHICS_API_VULKAN)
    //! Call xrGetVulkanGraphicsRequirementsKHR, populating function pointer if required.
    ...
    //! Call xrGetVulkanGraphicsRequirementsKHR (const overload - does not populate function pointer)
    ...
    #endif // defined(XR_USE_GRAPHICS_API_VULKAN)
    #if defined(XR_USE_GRAPHICS_API_D3D11)
    //! Call xrGetD3D11GraphicsRequirementsKHR, populating function pointer if required.
    ...
    //! Call xrGetD3D11GraphicsRequirementsKHR (const overload - does not populate function pointer)
    ...
    #endif // defined(XR_USE_GRAPHICS_API_D3D11)
    #if defined(XR_USE_GRAPHICS_API_D3D12)
    //! Call xrGetD3D12GraphicsRequirementsKHR, populating function pointer if required.
    ...
    //! Call xrGetD3D12GraphicsRequirementsKHR (const overload - does not populate function pointer)
    ...
    //! Call xrGetVisibilityMaskKHR (const overload - does not populate function pointer)
    ...
    #if defined(XR_USE_PLATFORM_WIN32)
    //! Call xrConvertWin32PerformanceCounterToTimeKHR, populating function pointer if required.
    ...
    //! Call xrConvertWin32PerformanceCounterToTimeKHR (const overload - does not populate function pointer)
    ...
    #endif // defined(XR_USE_PLATFORM_WIN32)
    #if defined(XR_USE_PLATFORM_WIN32)
    //! Call xrConvertTimeToWin32PerformanceCounterKHR, populating function pointer if required.
    ...
    //! Call xrConvertTimeToWin32PerformanceCounterKHR (const overload - does not populate function pointer)
    ...
    #endif // defined(XR_USE_PLATFORM_WIN32)
    #if defined(XR_USE_TIMESPEC)
    //! Call xrConvertTimespecTimeToTimeKHR, populating function pointer if required.
    ...
    //! Call xrConvertTimespecTimeToTimeKHR (const overload - does not populate function pointer)
    ...
    #endif // defined(XR_USE_TIMESPEC)
    #if defined(XR_USE_TIMESPEC)
    //! Call xrConvertTimeToTimespecTimeKHR, populating function pointer if required.
    ...
    //! Call xrConvertTimeToTimespecTimeKHR (const overload - does not populate function pointer)
    ...
    //! Call xrPerfSettingsSetPerformanceLevelEXT, populating function pointer if required.
    ...
    //! Call xrPerfSettingsSetPerformanceLevelEXT (const overload - does not populate function pointer)
    ...
    //! Call xrThermalGetTemperatureTrendEXT, populating function pointer if required.
    ...
    //! Call xrThermalGetTemperatureTrendEXT (const overload - does not populate function pointer)
    ...
    //! Call xrSetDebugUtilsObjectNameEXT, populating function pointer if required.
    ...
    //! Call xrSetDebugUtilsObjectNameEXT (const overload - does not populate function pointer)
    ...
    //! Call xrCreateDebugUtilsMessengerEXT, populating function pointer if required.
    ...
    //! Call xrCreateDebugUtilsMessengerEXT (const overload - does not populate function pointer)
    ...
    //! Call xrDestroyDebugUtilsMessengerEXT, populating function pointer if required.
    ...
    //! Call xrDestroyDebugUtilsMessengerEXT (const overload - does not populate function pointer)
    ...
    //! Call xrSubmitDebugUtilsMessageEXT, populating function pointer if required.
    ...
    //! Call xrSubmitDebugUtilsMessageEXT (const overload - does not populate function pointer)
    ...
    //! Call xrSessionBeginDebugUtilsLabelRegionEXT, populating function pointer if required.
    ...
    //! Call xrSessionBeginDebugUtilsLabelRegionEXT (const overload - does not populate function pointer)
    ...
    //! Call xrSessionEndDebugUtilsLabelRegionEXT, populating function pointer if required.
    ...
    //! Call xrSessionEndDebugUtilsLabelRegionEXT (const overload - does not populate function pointer)
    ...
    //! Call xrSessionInsertDebugUtilsLabelEXT, populating function pointer if required.
    ...
    //! Call xrSessionInsertDebugUtilsLabelEXT (const overload - does not populate function pointer)
    ...
    //! Call xrCreateSpatialAnchorMSFT (const overload - does not populate function pointer)
    ...
    //! Call xrCreateSpatialAnchorSpaceMSFT, populating function pointer if required.
    ...
    //! Call xrCreateSpatialAnchorSpaceMSFT (const overload - does not populate function pointer)
    ...
    //! Call xrDestroySpatialAnchorMSFT (const overload - does not populate function pointer)
...
OPENXR_HPP_INLINE ResultValueType<void>::type Instance::getInstanceProcAddr (
    const char* name, PFN_xrVoidFunction* function, Dispatch&& d) const {
    Result result = static_cast<Result>( d.xrGetInstanceProcAddr(this->get(), name, function) );
    return createResultValue(result, OPENXR_HPP_NAMESPACE_STRING "::Instance::getInstanceProcAddr");
}
#endif /*OPENXR_HPP_DISABLE_ENHANCED_MODE*/
...
OPENXR_HPP_INLINE typename ResultValueType<std::vector<XrApiLayerProperties, Allocator>>::type enumerateApiLayerProperties (
    Dispatch&& d)  {
    // Two-call idiom
    ...
    if (!unqualifiedSuccess(result) || propertyCountOutput == 0) {
        ...
        return createResultValue(result,properties, OPENXR_HPP_NAMESPACE_STRING "::enumerateApiLayerProperties");
    }
    do {
        properties.resize(propertyCountOutput, empty);
        propertyCapacityInput = static_cast<uint32_t>(properties.size());
        result = static_cast<Result>( d.xrEnumerateApiLayerProperties(propertyCapacityInput, &propertyCountOutput, properties.data()) );
...
#ifndef OPENXR_HPP_DISABLE_ENHANCED_MODE
template <typename Allocator, typename Dispatch>
OPENXR_HPP_INLINE typename ResultValueType<std::vector<XrExtensionProperties, Allocator>>::type enumerateInstanceExtensionProperties (
    ...
    if (!unqualifiedSuccess(result) || propertyCountOutput == 0) {
        ...
        return createResultValue(result,properties, OPENXR_HPP_NAMESPACE_STRING "::enumerateInstanceExtensionProperties");
    }
    do {
        properties.resize(propertyCountOutput, empty);
        propertyCapacityInput = static_cast<uint32_t>(properties.size());
        result = static_cast<Result>( d.xrEnumerateInstanceExtensionProperties(layerName, propertyCapacityInput, &propertyCountOutput, properties.data()) );
    } while (result == xr::Result::ErrorSizeInsufficient);
    if (result == xr::Result::Success) {
        OPENXR_HPP_ASSERT(propertyCountOutput <= properties.size());
        properties.resize(propertyCountOutput, empty);
...
OPENXR_HPP_INLINE typename ResultValueType<Instance>::type createInstance (
    ...
    return createResultValue(result,handle, OPENXR_HPP_NAMESPACE_STRING "::createInstance");
}
#ifndef OPENXR_HPP_NO_SMART_HANDLE
...
OPENXR_HPP_INLINE typename ResultValueType<UniqueHandle<Instance, impl::RemoveRefConst<Dispatch>>>::type createInstanceUnique (
    ...
    return createResultValue<Instance,impl::RemoveRefConst<Dispatch>>(result,handle,deleter, OPENXR_HPP_NAMESPACE_STRING "::createInstanceUnique");
}
...
OPENXR_HPP_INLINE ResultValueType<void>::type Instance::destroy (
    Dispatch&& d) const {
    Result result = static_cast<Result>( d.xrDestroyInstance(this->get()) );
    return createResultValue(result, OPENXR_HPP_NAMESPACE_STRING "::Instance::destroy");
}
#endif /*OPENXR_HPP_DISABLE_ENHANCED_MODE*/
...
OPENXR_HPP_INLINE ResultValueType<void>::type Instance::getInstanceProperties (
    XrInstanceProperties* instanceProperties, Dispatch&& d) const {
    Result result = static_cast<Result>( d.xrGetInstanceProperties(this->get(), instanceProperties) );
    return createResultValue(result, OPENXR_HPP_NAMESPACE_STRING "::Instance::getInstanceProperties");
}
#endif /*OPENXR_HPP_DISABLE_ENHANCED_MODE*/
...
OPENXR_HPP_INLINE Result Instance::pollEvent (
    XrEventDataBuffer* eventData, Dispatch&& d) const {
    Result result = static_cast<Result>( d.xrPollEvent(this->get(), eventData) );
    return createResultValue(result, OPENXR_HPP_NAMESPACE_STRING "::Instance::pollEvent", {Result::Success, Result::EventUnavailable});
}
#endif /*OPENXR_HPP_DISABLE_ENHANCED_MODE*/
...
OPENXR_HPP_INLINE ResultValueType<void>::type Instance::resultToString (
    Result value, char buffer[XR_MAX_RESULT_STRING_SIZE], Dispatch&& d) const {
    Result result = static_cast<Result>( d.xrResultToString(this->get(), OPENXR_HPP_NAMESPACE::get(value), buffer) );
    return createResultValue(result, OPENXR_HPP_NAMESPACE_STRING "::Instance::resultToString");
}
#endif /*OPENXR_HPP_DISABLE_ENHANCED_MODE*/
...
OPENXR_HPP_INLINE ResultValueType<void>::type Instance::structureTypeToString (
    StructureType value, char buffer[XR_MAX_STRUCTURE_NAME_SIZE], Dispatch&& d) const {
    Result result = static_cast<Result>( d.xrStructureTypeToString(this->get(), OPENXR_HPP_NAMESPACE::get(value), buffer) );
    return createResultValue(result, OPENXR_HPP_NAMESPACE_STRING "::Instance::structureTypeToString");
}
#endif /*OPENXR_HPP_DISABLE_ENHANCED_MODE*/
...
OPENXR_HPP_INLINE ResultValueType<void>::type Instance::getSystem (
    const XrSystemGetInfo* getInfo, XrSystemId* systemId, Dispatch&& d) const {
    Result result = static_cast<Result>( d.xrGetSystem(this->get(), getInfo, systemId) );
    return createResultValue(result, OPENXR_HPP_NAMESPACE_STRING "::Instance::getSystem");
}
#endif /*OPENXR_HPP_DISABLE_ENHANCED_MODE*/
...
OPENXR_HPP_INLINE ResultValueType<void>::type Instance::getSystemProperties (
    XrSystemId systemId, XrSystemProperties* properties, Dispatch&& d) const {
    Result result = static_cast<Result>( d.xrGetSystemProperties(this->get(), systemId, properties) );
    return createResultValue(result, OPENXR_HPP_NAMESPACE_STRING "::Instance::getSystemProperties");
}
#endif /*OPENXR_HPP_DISABLE_ENHANCED_MODE*/
...
OPENXR_HPP_INLINE ResultValueType<void>::type Instance::enumerateEnvironmentBlendModes (
    ...
    Result result = static_cast<Result>( d.xrEnumerateEnvironmentBlendModes(this->get(), systemId, OPENXR_HPP_NAMESPACE::get(viewConfigurationType), environmentBlendModeCapacityInput, environmentBlendModeCountOutput, environmentBlendModes_tmp) );
    environmentBlendModes = static_cast<EnvironmentBlendMode>(environmentBlendModes_tmp);
    return createResultValue(result, OPENXR_HPP_NAMESPACE_STRING "::Instance::enumerateEnvironmentBlendModes");
}
#endif /*OPENXR_HPP_DISABLE_ENHANCED_MODE*/
...
OPENXR_HPP_INLINE typename ResultValueType<Session>::type Instance::createSession (
    ...
    return createResultValue(result,handle, OPENXR_HPP_NAMESPACE_STRING "::Instance::createSession");
}
#ifndef OPENXR_HPP_NO_SMART_HANDLE
...
OPENXR_HPP_INLINE typename ResultValueType<UniqueHandle<Session, impl::RemoveRefConst<Dispatch>>>::type Instance::createSessionUnique (
    ...
    Result result = static_cast<Result>( d.xrCreateSession(this->get(), createInfo, handle.put()) );
    ObjectDestroy<impl::RemoveRefConst<Dispatch>> deleter{d};
    return createResultValue<Session,impl::RemoveRefConst<Dispatch>>(result,handle,deleter, OPENXR_HPP_NAMESPACE_STRING "::Instance::createSessionUnique");
}
...
OPENXR_HPP_INLINE ResultValueType<void>::type Session::destroy (
    Dispatch&& d) const {
    Result result = static_cast<Result>( d.xrDestroySession(this->get()) );
    return createResultValue(result, OPENXR_HPP_NAMESPACE_STRING "::Session::destroy");
}
#endif /*OPENXR_HPP_DISABLE_ENHANCED_MODE*/
...
#ifndef OPENXR_HPP_DISABLE_ENHANCED_MODE
template <typename Allocator, typename Dispatch>
OPENXR_HPP_INLINE ResultValue<std::vector<ReferenceSpaceType, Allocator>> Session::enumerateReferenceSpaces (
    Dispatch&& d) const {
    // Two-call idiom
    ...
    if (!unqualifiedSuccess(result) || spaceCountOutput == 0) {
        ...
        return createResultValue(result,spaces, OPENXR_HPP_NAMESPACE_STRING "::Session::enumerateReferenceSpaces", {Result::Success, Result::SessionLossPending});
    }
    do {
        spaces.resize(spaceCountOutput);
        spaceCapacityInput = static_cast<uint32_t>(spaces.size());
        result = static_cast<Result>( d.xrEnumerateReferenceSpaces(this->get(), spaceCapacityInput, &spaceCountOutput, (XrReferenceSpaceType*)spaces.data()) );
    } while (result == xr::Result::ErrorSizeInsufficient);
    if (result == xr::Result::Success) {
...
OPENXR_HPP_INLINE ResultValue<std::vector<ReferenceSpaceType, Allocator>> Session::enumerateReferenceSpaces (
    ...
    do {
        spaces.resize(spaceCountOutput);
        spaceCapacityInput = static_cast<uint32_t>(spaces.size());
        result = static_cast<Result>( d.xrEnumerateReferenceSpaces(this->get(), spaceCapacityInput, &spaceCountOutput, spaces.data()) );
    } while (result == xr::Result::ErrorSizeInsufficient);
    if (result == xr::Result::Success) {
        OPENXR_HPP_ASSERT(spaceCountOutput <= spaces.size());
        spaces.resize(spaceCountOutput);
...
OPENXR_HPP_INLINE ResultValue<Space> Session::createReferenceSpace (
    ...
    return createResultValue(result,handle, OPENXR_HPP_NAMESPACE_STRING "::Session::createReferenceSpace", {Result::Success, Result::SessionLossPending});
}
#ifndef OPENXR_HPP_NO_SMART_HANDLE
...
OPENXR_HPP_INLINE ResultValue<UniqueHandle<Space, impl::RemoveRefConst<Dispatch>>> Session::createReferenceSpaceUnique (
    ...
    Result result = static_cast<Result>( d.xrCreateReferenceSpace(this->get(), createInfo, handle.put()) );
    ObjectDestroy<impl::RemoveRefConst<Dispatch>> deleter{d};
    return createResultValue<Space,impl::RemoveRefConst<Dispatch>>(result,handle,deleter, OPENXR_HPP_NAMESPACE_STRING "::Session::createReferenceSpaceUnique", {Result::Success, Result::SessionLossPending});
}
...
OPENXR_HPP_INLINE Result Session::getReferenceSpaceBoundsRect (
    ReferenceSpaceType referenceSpaceType, XrExtent2Df* bounds, Dispatch&& d) const {
    Result result = static_cast<Result>( d.xrGetReferenceSpaceBoundsRect(this->get(), OPENXR_HPP_NAMESPACE::get(referenceSpaceType), bounds) );
    return createResultValue(result, OPENXR_HPP_NAMESPACE_STRING "::Session::getReferenceSpaceBoundsRect", {Result::Success, Result::SpaceBoundsUnavailable, Result::SessionLossPending});
}
#endif /*OPENXR_HPP_DISABLE_ENHANCED_MODE*/
...
OPENXR_HPP_INLINE ResultValue<Space> Session::createActionSpace (
    ...
    return createResultValue(result,handle, OPENXR_HPP_NAMESPACE_STRING "::Session::createActionSpace", {Result::Success, Result::SessionLossPending});
}
#ifndef OPENXR_HPP_NO_SMART_HANDLE
...
OPENXR_HPP_INLINE ResultValue<UniqueHandle<Space, impl::RemoveRefConst<Dispatch>>> Session::createActionSpaceUnique (
    ...
    Result result = static_cast<Result>( d.xrCreateActionSpace(this->get(), createInfo, handle.put()) );
    ObjectDestroy<impl::RemoveRefConst<Dispatch>> deleter{d};
    return createResultValue<Space,impl::RemoveRefConst<Dispatch>>(result,handle,deleter, OPENXR_HPP_NAMESPACE_STRING "::Session::createActionSpaceUnique", {Result::Success, Result::SessionLossPending});
}
...
OPENXR_HPP_INLINE Result Space::locateSpace (
    Space baseSpace, XrTime time, XrSpaceLocation* location, Dispatch&& d) const {
    Result result = static_cast<Result>( d.xrLocateSpace(this->get(), baseSpace.get(), time, location) );
    return createResultValue(result, OPENXR_HPP_NAMESPACE_STRING "::Space::locateSpace", {Result::Success, Result::SessionLossPending});
}
#endif /*OPENXR_HPP_DISABLE_ENHANCED_MODE*/
...
OPENXR_HPP_INLINE ResultValueType<void>::type Space::destroy (
    Dispatch&& d) const {
    Result result = static_cast<Result>( d.xrDestroySpace(this->get()) );
    return createResultValue(result, OPENXR_HPP_NAMESPACE_STRING "::Space::destroy");
}
#endif /*OPENXR_HPP_DISABLE_ENHANCED_MODE*/
...
OPENXR_HPP_INLINE ResultValueType<void>::type Instance::enumerateViewConfigurations (
    ...
    Result result = static_cast<Result>( d.xrEnumerateViewConfigurations(this->get(), systemId, viewConfigurationTypeCapacityInput, viewConfigurationTypeCountOutput, viewConfigurationTypes_tmp) );
    viewConfigurationTypes = static_cast<ViewConfigurationType>(viewConfigurationTypes_tmp);
    return createResultValue(result, OPENXR_HPP_NAMESPACE_STRING "::Instance::enumerateViewConfigurations");
}
#endif /*OPENXR_HPP_DISABLE_ENHANCED_MODE*/
...
OPENXR_HPP_INLINE ResultValueType<void>::type Instance::getViewConfigurationProperties (
    XrSystemId systemId, ViewConfigurationType viewConfigurationType, XrViewConfigurationProperties* configurationProperties, Dispatch&& d) const {
    Result result = static_cast<Result>( d.xrGetViewConfigurationProperties(this->get(), systemId, OPENXR_HPP_NAMESPACE::get(viewConfigurationType), configurationProperties) );
    return createResultValue(result, OPENXR_HPP_NAMESPACE_STRING "::Instance::getViewConfigurationProperties");
}
#endif /*OPENXR_HPP_DISABLE_ENHANCED_MODE*/
...
OPENXR_HPP_INLINE Result Instance::enumerateViewConfigurationViews (
    XrSystemId systemId, ViewConfigurationType viewConfigurationType, uint32_t viewCapacityInput, uint32_t* viewCountOutput, XrViewConfigurationView* views, Dispatch&& d) const {
    Result result = static_cast<Result>( d.xrEnumerateViewConfigurationViews(this->get(), systemId, OPENXR_HPP_NAMESPACE::get(viewConfigurationType), viewCapacityInput, viewCountOutput, views) );
    return result;
}
#ifndef OPENXR_HPP_DISABLE_ENHANCED_MODE
template <typename Allocator, typename Dispatch>
OPENXR_HPP_INLINE typename ResultValueType<std::vector<XrViewConfigurationView, Allocator>>::type Instance::enumerateViewConfigurationViews (
    ...
    if (!unqualifiedSuccess(result) || viewCountOutput == 0) {
        ...
        return createResultValue(result,views, OPENXR_HPP_NAMESPACE_STRING "::Instance::enumerateViewConfigurationViews");
    }
    do {
        views.resize(viewCountOutput, empty);
        viewCapacityInput = static_cast<uint32_t>(views.size());
        result = static_cast<Result>( d.xrEnumerateViewConfigurationViews(this->get(), systemId, OPENXR_HPP_NAMESPACE::get(viewConfigurationType), viewCapacityInput, &viewCountOutput, views.data()) );
    } while (result == xr::Result::ErrorSizeInsufficient);
    if (result == xr::Result::Success) {
...
#ifndef OPENXR_HPP_DISABLE_ENHANCED_MODE
template <typename Allocator, typename Dispatch>
OPENXR_HPP_INLINE ResultValue<std::vector<int64_t, Allocator>> Session::enumerateSwapchainFormats (
    Dispatch&& d) const {
    // Two-call idiom
    ...
    if (!unqualifiedSuccess(result) || formatCountOutput == 0) {
        ...
        return createResultValue(result,formats, OPENXR_HPP_NAMESPACE_STRING "::Session::enumerateSwapchainFormats", {Result::Success, Result::SessionLossPending});
    }
    do {
        formats.resize(formatCountOutput);
        formatCapacityInput = static_cast<uint32_t>(formats.size());
        result = static_cast<Result>( d.xrEnumerateSwapchainFormats(this->get(), formatCapacityInput, &formatCountOutput, formats.data()) );
    } while (result == xr::Result::ErrorSizeInsufficient);
    if (result == xr::Result::Success) {
...
OPENXR_HPP_INLINE ResultValue<Swapchain> Session::createSwapchain (
    ...
    return createResultValue(result,handle, OPENXR_HPP_NAMESPACE_STRING "::Session::createSwapchain", {Result::Success, Result::SessionLossPending});
}
#ifndef OPENXR_HPP_NO_SMART_HANDLE
...
OPENXR_HPP_INLINE ResultValue<UniqueHandle<Swapchain, impl::RemoveRefConst<Dispatch>>> Session::createSwapchainUnique (
    ...
    Result result = static_cast<Result>( d.xrCreateSwapchain(this->get(), createInfo, handle.put()) );
    ObjectDestroy<impl::RemoveRefConst<Dispatch>> deleter{d};
    return createResultValue<Swapchain,impl::RemoveRefConst<Dispatch>>(result,handle,deleter, OPENXR_HPP_NAMESPACE_STRING "::Session::createSwapchainUnique", {Result::Success, Result::SessionLossPending});
}
...
OPENXR_HPP_INLINE ResultValueType<void>::type Swapchain::destroy (
    Dispatch&& d) const {
    Result result = static_cast<Result>( d.xrDestroySwapchain(this->get()) );
    return createResultValue(result, OPENXR_HPP_NAMESPACE_STRING "::Swapchain::destroy");
}
#endif /*OPENXR_HPP_DISABLE_ENHANCED_MODE*/
...
OPENXR_HPP_INLINE Result Swapchain::enumerateSwapchainImages (
    uint32_t imageCapacityInput, uint32_t* imageCountOutput, XrSwapchainImageBaseHeader* images, Dispatch&& d) const {
    Result result = static_cast<Result>( d.xrEnumerateSwapchainImages(this->get(), imageCapacityInput, imageCountOutput, images) );
    return createResultValue(result, OPENXR_HPP_NAMESPACE_STRING "::Swapchain::enumerateSwapchainImages", {Result::Success, Result::SessionLossPending});
}
#endif /*OPENXR_HPP_DISABLE_ENHANCED_MODE*/
...
OPENXR_HPP_INLINE Result Swapchain::acquireSwapchainImage (
    const XrSwapchainImageAcquireInfo* acquireInfo, uint32_t* index, Dispatch&& d) const {
    Result result = static_cast<Result>( d.xrAcquireSwapchainImage(this->get(), acquireInfo, index) );
    return createResultValue(result, OPENXR_HPP_NAMESPACE_STRING "::Swapchain::acquireSwapchainImage", {Result::Success, Result::SessionLossPending});
}
#endif /*OPENXR_HPP_DISABLE_ENHANCED_MODE*/
...
OPENXR_HPP_INLINE Result Swapchain::waitSwapchainImage (
    const XrSwapchainImageWaitInfo* waitInfo, Dispatch&& d) const {
    Result result = static_cast<Result>( d.xrWaitSwapchainImage(this->get(), waitInfo) );
    return createResultValue(result, OPENXR_HPP_NAMESPACE_STRING "::Swapchain::waitSwapchainImage", {Result::Success, Result::TimeoutExpired, Result::SessionLossPending});
}
#endif /*OPENXR_HPP_DISABLE_ENHANCED_MODE*/
...
OPENXR_HPP_INLINE Result Swapchain::releaseSwapchainImage (
    const XrSwapchainImageReleaseInfo* releaseInfo, Dispatch&& d) const {
    Result result = static_cast<Result>( d.xrReleaseSwapchainImage(this->get(), releaseInfo) );
    return createResultValue(result, OPENXR_HPP_NAMESPACE_STRING "::Swapchain::releaseSwapchainImage", {Result::Success, Result::SessionLossPending});
}
#endif /*OPENXR_HPP_DISABLE_ENHANCED_MODE*/
...
OPENXR_HPP_INLINE Result Session::beginSession (
    const XrSessionBeginInfo* beginInfo, Dispatch&& d) const {
    Result result = static_cast<Result>( d.xrBeginSession(this->get(), beginInfo) );
    return createResultValue(result, OPENXR_HPP_NAMESPACE_STRING "::Session::beginSession", {Result::Success, Result::SessionLossPending});
}
#endif /*OPENXR_HPP_DISABLE_ENHANCED_MODE*/
...
OPENXR_HPP_INLINE Result Session::endSession (
    Dispatch&& d) const {
    Result result = static_cast<Result>( d.xrEndSession(this->get()) );
    return createResultValue(result, OPENXR_HPP_NAMESPACE_STRING "::Session::endSession", {Result::Success, Result::SessionLossPending});
}
#endif /*OPENXR_HPP_DISABLE_ENHANCED_MODE*/
...
OPENXR_HPP_INLINE Result Session::requestExitSession (
    Dispatch&& d) const {
    Result result = static_cast<Result>( d.xrRequestExitSession(this->get()) );
    return createResultValue(result, OPENXR_HPP_NAMESPACE_STRING "::Session::requestExitSession", {Result::Success, Result::SessionLossPending});
}
#endif /*OPENXR_HPP_DISABLE_ENHANCED_MODE*/
...
OPENXR_HPP_INLINE Result Session::waitFrame (
    const XrFrameWaitInfo* frameWaitInfo, XrFrameState* frameState, Dispatch&& d) const {
    Result result = static_cast<Result>( d.xrWaitFrame(this->get(), frameWaitInfo, frameState) );
    return createResultValue(result, OPENXR_HPP_NAMESPACE_STRING "::Session::waitFrame", {Result::Success, Result::SessionLossPending});
}
#endif /*OPENXR_HPP_DISABLE_ENHANCED_MODE*/
...
OPENXR_HPP_INLINE Result Session::beginFrame (
    const XrFrameBeginInfo* frameBeginInfo, Dispatch&& d) const {
    Result result = static_cast<Result>( d.xrBeginFrame(this->get(), frameBeginInfo) );
    return createResultValue(result, OPENXR_HPP_NAMESPACE_STRING "::Session::beginFrame", {Result::Success, Result::SessionLossPending, Result::FrameDiscarded});
}
#endif /*OPENXR_HPP_DISABLE_ENHANCED_MODE*/
...
OPENXR_HPP_INLINE Result Session::endFrame (
    const XrFrameEndInfo* frameEndInfo, Dispatch&& d) const {
    Result result = static_cast<Result>( d.xrEndFrame(this->get(), frameEndInfo) );
    return createResultValue(result, OPENXR_HPP_NAMESPACE_STRING "::Session::endFrame", {Result::Success, Result::SessionLossPending});
}
#endif /*OPENXR_HPP_DISABLE_ENHANCED_MODE*/
...
#ifndef OPENXR_HPP_DISABLE_ENHANCED_MODE
template <typename Allocator, typename Dispatch>
OPENXR_HPP_INLINE ResultValue<std::vector<XrView, Allocator>> Session::locateViews (
    ...
    if (!unqualifiedSuccess(result) || viewCountOutput == 0) {
        ...
        return createResultValue(result,views, OPENXR_HPP_NAMESPACE_STRING "::Session::locateViews", {Result::Success, Result::SessionLossPending});
    }
    do {
        views.resize(viewCountOutput, empty);
        viewCapacityInput = static_cast<uint32_t>(views.size());
        result = static_cast<Result>( d.xrLocateViews(this->get(), viewLocateInfo, viewState, viewCapacityInput, &viewCountOutput, views.data()) );
    } while (result == xr::Result::ErrorSizeInsufficient);
    if (result == xr::Result::Success) {
        OPENXR_HPP_ASSERT(viewCountOutput <= views.size());
        views.resize(viewCountOutput, empty);
...
OPENXR_HPP_INLINE ResultValueType<void>::type Instance::stringToPath (
    const char* pathString, XrPath* path, Dispatch&& d) const {
    Result result = static_cast<Result>( d.xrStringToPath(this->get(), pathString, path) );
    return createResultValue(result, OPENXR_HPP_NAMESPACE_STRING "::Instance::stringToPath");
}
#endif /*OPENXR_HPP_DISABLE_ENHANCED_MODE*/
...
OPENXR_HPP_INLINE Result Instance::pathToString (
    XrPath path, uint32_t bufferCapacityInput, uint32_t* bufferCountOutput, char* buffer, Dispatch&& d) const {
    Result result = static_cast<Result>( d.xrPathToString(this->get(), path, bufferCapacityInput, bufferCountOutput, buffer) );
    return result;
}
#ifndef OPENXR_HPP_DISABLE_ENHANCED_MODE
template <typename Allocator, typename Dispatch>
OPENXR_HPP_INLINE typename ResultValueType<std::basic_string<char, std::char_traits<char>, Allocator>>::type Instance::pathToString (
    XrPath path, Dispatch&& d) const {
    // Two-call idiom
    ...
    if (!unqualifiedSuccess(result) || bufferCountOutput == 0) {
        ...
        return createResultValue(result,str, OPENXR_HPP_NAMESPACE_STRING "::Instance::pathToString");
    }
    do {
        buffer.resize(bufferCountOutput);
        bufferCapacityInput = static_cast<uint32_t>(buffer.size());
        result = static_cast<Result>( d.xrPathToString(this->get(), path, bufferCapacityInput, &bufferCountOutput, buffer.data()) );
    } while (result == xr::Result::ErrorSizeInsufficient);
    if (result == xr::Result::Success) {
...
OPENXR_HPP_INLINE typename ResultValueType<ActionSet>::type Instance::createActionSet (
    ...
    return createResultValue(result,handle, OPENXR_HPP_NAMESPACE_STRING "::Instance::createActionSet");
}
#ifndef OPENXR_HPP_NO_SMART_HANDLE
...
OPENXR_HPP_INLINE typename ResultValueType<UniqueHandle<ActionSet, impl::RemoveRefConst<Dispatch>>>::type Instance::createActionSetUnique (
    ...
    Result result = static_cast<Result>( d.xrCreateActionSet(this->get(), createInfo, handle.put()) );
    ObjectDestroy<impl::RemoveRefConst<Dispatch>> deleter{d};
    return createResultValue<ActionSet,impl::RemoveRefConst<Dispatch>>(result,handle,deleter, OPENXR_HPP_NAMESPACE_STRING "::Instance::createActionSetUnique");
}
...
OPENXR_HPP_INLINE ResultValueType<void>::type ActionSet::destroy (
    Dispatch&& d) const {
    Result result = static_cast<Result>( d.xrDestroyActionSet(this->get()) );
    return createResultValue(result, OPENXR_HPP_NAMESPACE_STRING "::ActionSet::destroy");
}
#endif /*OPENXR_HPP_DISABLE_ENHANCED_MODE*/
...
OPENXR_HPP_INLINE typename ResultValueType<Action>::type ActionSet::createAction (
    ...
    return createResultValue(result,handle, OPENXR_HPP_NAMESPACE_STRING "::ActionSet::createAction");
}
#ifndef OPENXR_HPP_NO_SMART_HANDLE
...
OPENXR_HPP_INLINE typename ResultValueType<UniqueHandle<Action, impl::RemoveRefConst<Dispatch>>>::type ActionSet::createActionUnique (
    ...
    Result result = static_cast<Result>( d.xrCreateAction(this->get(), createInfo, handle.put()) );
    ObjectDestroy<impl::RemoveRefConst<Dispatch>> deleter{d};
    return createResultValue<Action,impl::RemoveRefConst<Dispatch>>(result,handle,deleter, OPENXR_HPP_NAMESPACE_STRING "::ActionSet::createActionUnique");
}
...
OPENXR_HPP_INLINE ResultValueType<void>::type Action::destroy (
    Dispatch&& d) const {
    Result result = static_cast<Result>( d.xrDestroyAction(this->get()) );
    return createResultValue(result, OPENXR_HPP_NAMESPACE_STRING "::Action::destroy");
}
#endif /*OPENXR_HPP_DISABLE_ENHANCED_MODE*/
...
OPENXR_HPP_INLINE ResultValueType<void>::type Instance::suggestInteractionProfileBindings (
    const XrInteractionProfileSuggestedBinding* suggestedBindings, Dispatch&& d) const {
    Result result = static_cast<Result>( d.xrSuggestInteractionProfileBindings(this->get(), suggestedBindings) );
    return createResultValue(result, OPENXR_HPP_NAMESPACE_STRING "::Instance::suggestInteractionProfileBindings");
}
#endif /*OPENXR_HPP_DISABLE_ENHANCED_MODE*/
...
OPENXR_HPP_INLINE Result Session::attachSessionActionSets (
    const XrSessionActionSetsAttachInfo* attachInfo, Dispatch&& d) const {
    Result result = static_cast<Result>( d.xrAttachSessionActionSets(this->get(), attachInfo) );
    return createResultValue(result, OPENXR_HPP_NAMESPACE_STRING "::Session::attachSessionActionSets", {Result::Success, Result::SessionLossPending});
}
#endif /*OPENXR_HPP_DISABLE_ENHANCED_MODE*/
...
OPENXR_HPP_INLINE Result Session::getCurrentInteractionProfile (
    XrPath topLevelUserPath, XrInteractionProfileState* interactionProfile, Dispatch&& d) const {
    Result result = static_cast<Result>( d.xrGetCurrentInteractionProfile(this->get(), topLevelUserPath, interactionProfile) );
    return createResultValue(result, OPENXR_HPP_NAMESPACE_STRING "::Session::getCurrentInteractionProfile", {Result::Success, Result::SessionLossPending});
}
#endif /*OPENXR_HPP_DISABLE_ENHANCED_MODE*/
...
OPENXR_HPP_INLINE Result Session::getActionStateBoolean (
    const XrActionStateGetInfo* getInfo, XrActionStateBoolean* state, Dispatch&& d) const {
    Result result = static_cast<Result>( d.xrGetActionStateBoolean(this->get(), getInfo, state) );
    return createResultValue(result, OPENXR_HPP_NAMESPACE_STRING "::Session::getActionStateBoolean", {Result::Success, Result::SessionLossPending});
}
#endif /*OPENXR_HPP_DISABLE_ENHANCED_MODE*/
...
OPENXR_HPP_INLINE Result Session::getActionStateFloat (
    const XrActionStateGetInfo* getInfo, XrActionStateFloat* state, Dispatch&& d) const {
    Result result = static_cast<Result>( d.xrGetActionStateFloat(this->get(), getInfo, state) );
    return createResultValue(result, OPENXR_HPP_NAMESPACE_STRING "::Session::getActionStateFloat", {Result::Success, Result::SessionLossPending});
}
#endif /*OPENXR_HPP_DISABLE_ENHANCED_MODE*/
...
OPENXR_HPP_INLINE Result Session::getActionStateVector2f (
    const XrActionStateGetInfo* getInfo, XrActionStateVector2f* state, Dispatch&& d) const {
    Result result = static_cast<Result>( d.xrGetActionStateVector2f(this->get(), getInfo, state) );
    return createResultValue(result, OPENXR_HPP_NAMESPACE_STRING "::Session::getActionStateVector2f", {Result::Success, Result::SessionLossPending});
}
#endif /*OPENXR_HPP_DISABLE_ENHANCED_MODE*/
...
OPENXR_HPP_INLINE Result Session::getActionStatePose (
    const XrActionStateGetInfo* getInfo, XrActionStatePose* state, Dispatch&& d) const {
    Result result = static_cast<Result>( d.xrGetActionStatePose(this->get(), getInfo, state) );
    return createResultValue(result, OPENXR_HPP_NAMESPACE_STRING "::Session::getActionStatePose", {Result::Success, Result::SessionLossPending});
}
#endif /*OPENXR_HPP_DISABLE_ENHANCED_MODE*/
...
OPENXR_HPP_INLINE Result Session::syncActions (
    const XrActionsSyncInfo* syncInfo, Dispatch&& d) const {
    Result result = static_cast<Result>( d.xrSyncActions(this->get(), syncInfo) );
    return createResultValue(result, OPENXR_HPP_NAMESPACE_STRING "::Session::syncActions", {Result::Success, Result::SessionLossPending, Result::SessionNotFocused});
}
#endif /*OPENXR_HPP_DISABLE_ENHANCED_MODE*/
...
#ifndef OPENXR_HPP_DISABLE_ENHANCED_MODE
template <typename Allocator, typename Dispatch>
OPENXR_HPP_INLINE ResultValue<std::vector<XrPath, Allocator>> Session::enumerateBoundSourcesForAction (
    ...
    if (!unqualifiedSuccess(result) || sourceCountOutput == 0) {
        ...
        return createResultValue(result,sources, OPENXR_HPP_NAMESPACE_STRING "::Session::enumerateBoundSourcesForAction", {Result::Success, Result::SessionLossPending});
    }
    do {
        sources.resize(sourceCountOutput);
        sourceCapacityInput = static_cast<uint32_t>(sources.size());
        result = static_cast<Result>( d.xrEnumerateBoundSourcesForAction(this->get(), enumerateInfo, sourceCapacityInput, &sourceCountOutput, sources.data()) );
    } while (result == xr::Result::ErrorSizeInsufficient);
    if (result == xr::Result::Success) {
...
#ifndef OPENXR_HPP_DISABLE_ENHANCED_MODE
template <typename Allocator, typename Dispatch>
OPENXR_HPP_INLINE ResultValue<std::basic_string<char, std::char_traits<char>, Allocator>> Session::getInputSourceLocalizedName (
    ...
    if (!unqualifiedSuccess(result) || bufferCountOutput == 0) {
        ...
        return createResultValue(result,str, OPENXR_HPP_NAMESPACE_STRING "::Session::getInputSourceLocalizedName", {Result::Success, Result::SessionLossPending});
    }
    do {
        buffer.resize(bufferCountOutput);
        bufferCapacityInput = static_cast<uint32_t>(buffer.size());
        result = static_cast<Result>( d.xrGetInputSourceLocalizedName(this->get(), getInfo, bufferCapacityInput, &bufferCountOutput, buffer.data()) );
    } while (result == xr::Result::ErrorSizeInsufficient);
    if (result == xr::Result::Success) {
        OPENXR_HPP_ASSERT(bufferCountOutput <= buffer.size());
        buffer.resize(bufferCountOutput);
...
OPENXR_HPP_INLINE Result Session::applyHapticFeedback (
    const XrHapticActionInfo* hapticActionInfo, const XrHapticBaseHeader* hapticFeedback, Dispatch&& d) const {
    Result result = static_cast<Result>( d.xrApplyHapticFeedback(this->get(), hapticActionInfo, hapticFeedback) );
    return createResultValue(result, OPENXR_HPP_NAMESPACE_STRING "::Session::applyHapticFeedback", {Result::Success, Result::SessionLossPending});
}
#endif /*OPENXR_HPP_DISABLE_ENHANCED_MODE*/
...
OPENXR_HPP_INLINE Result Session::stopHapticFeedback (
    const XrHapticActionInfo* hapticActionInfo, Dispatch&& d) const {
    Result result = static_cast<Result>( d.xrStopHapticFeedback(this->get(), hapticActionInfo) );
    return createResultValue(result, OPENXR_HPP_NAMESPACE_STRING "::Session::stopHapticFeedback", {Result::Success, Result::SessionLossPending});
}
#endif /*OPENXR_HPP_DISABLE_ENHANCED_MODE*/
...
OPENXR_HPP_INLINE Result Session::setAndroidApplicationThreadKHR (
    AndroidThreadTypeKHR threadType, uint32_t threadId, Dispatch&& d) const {
    Result result = static_cast<Result>( d.xrSetAndroidApplicationThreadKHR(this->get(), OPENXR_HPP_NAMESPACE::get(threadType), threadId) );
    return createResultValue(result, OPENXR_HPP_NAMESPACE_STRING "::Session::setAndroidApplicationThreadKHR", {Result::Success, Result::SessionLossPending});
}
#endif /*OPENXR_HPP_DISABLE_ENHANCED_MODE*/
...
template <typename Dispatch>
OPENXR_HPP_INLINE ResultValue<jobject> Session::createSwapchainAndroidSurfaceKHR (
    const XrSwapchainCreateInfo* info, Swapchain& swapchain, Dispatch&& d) const {
    jobject handle;
    Result result = static_cast<Result>( d.xrCreateSwapchainAndroidSurfaceKHR(this->get(), info, swapchain.put(), handle.put()) );
    return createResultValue(result,handle, OPENXR_HPP_NAMESPACE_STRING "::Session::createSwapchainAndroidSurfaceKHR", {Result::Success, Result::SessionLossPending});
}
#ifndef OPENXR_HPP_NO_SMART_HANDLE

template <typename Dispatch>
OPENXR_HPP_INLINE ResultValue<UniqueHandle<jobject, impl::RemoveRefConst<Dispatch>>> Session::createSwapchainAndroidSurfaceUniqueKHR (
    const XrSwapchainCreateInfo* info, Swapchain& swapchain, Dispatch&& d) const {
    jobject handle;
    Result result = static_cast<Result>( d.xrCreateSwapchainAndroidSurfaceKHR(this->get(), info, swapchain.put(), handle.put()) );
    ObjectDestroy<impl::RemoveRefConst<Dispatch>> deleter{d};
    return createResultValue<jobject,impl::RemoveRefConst<Dispatch>>(result,handle,deleter, OPENXR_HPP_NAMESPACE_STRING "::Session::createSwapchainAndroidSurfaceUniqueKHR", {Result::Success, Result::SessionLossPending});
}
...
OPENXR_HPP_INLINE ResultValueType<void>::type Instance::getOpenGLGraphicsRequirementsKHR (
    XrSystemId systemId, XrGraphicsRequirementsOpenGLKHR* graphicsRequirements, Dispatch&& d) const {
    Result result = static_cast<Result>( d.xrGetOpenGLGraphicsRequirementsKHR(this->get(), systemId, graphicsRequirements) );
    return createResultValue(result, OPENXR_HPP_NAMESPACE_STRING "::Instance::getOpenGLGraphicsRequirementsKHR");
}
#endif /*OPENXR_HPP_DISABLE_ENHANCED_MODE*/
...
OPENXR_HPP_INLINE ResultValueType<void>::type Instance::getOpenGLESGraphicsRequirementsKHR (
    XrSystemId systemId, XrGraphicsRequirementsOpenGLESKHR* graphicsRequirements, Dispatch&& d) const {
    Result result = static_cast<Result>( d.xrGetOpenGLESGraphicsRequirementsKHR(this->get(), systemId, graphicsRequirements) );
    return createResultValue(result, OPENXR_HPP_NAMESPACE_STRING "::Instance::getOpenGLESGraphicsRequirementsKHR");
}
#endif /*OPENXR_HPP_DISABLE_ENHANCED_MODE*/
...
OPENXR_HPP_INLINE Result Instance::getVulkanInstanceExtensionsKHR (
    XrSystemId systemId, uint32_t bufferCapacityInput, uint32_t* bufferCountOutput, char* buffer, Dispatch&& d) const {
    Result result = static_cast<Result>( d.xrGetVulkanInstanceExtensionsKHR(this->get(), systemId, bufferCapacityInput, bufferCountOutput, buffer) );
    return result;
}
#ifndef OPENXR_HPP_DISABLE_ENHANCED_MODE
template <typename Allocator, typename Dispatch>
OPENXR_HPP_INLINE typename ResultValueType<std::basic_string<char, std::char_traits<char>, Allocator>>::type Instance::getVulkanInstanceExtensionsKHR (
    XrSystemId systemId, Dispatch&& d) const {
    // Two-call idiom
    std::vector<char, Allocator> buffer;
            uint32_t bufferCountOutput = 0;
    ...
    if (!unqualifiedSuccess(result) || bufferCountOutput == 0) {
        ...
        return createResultValue(result,str, OPENXR_HPP_NAMESPACE_STRING "::Instance::getVulkanInstanceExtensionsKHR");
    }
    do {
        buffer.resize(bufferCountOutput);
        bufferCapacityInput = static_cast<uint32_t>(buffer.size());
        result = static_cast<Result>( d.xrGetVulkanInstanceExtensionsKHR(this->get(), systemId, bufferCapacityInput, &bufferCountOutput, buffer.data()) );
    } while (result == xr::Result::ErrorSizeInsufficient);
    if (result == xr::Result::Success) {
        OPENXR_HPP_ASSERT(bufferCountOutput <= buffer.size());
        buffer.resize(bufferCountOutput);
...
OPENXR_HPP_INLINE Result Instance::getVulkanDeviceExtensionsKHR (
    XrSystemId systemId, uint32_t bufferCapacityInput, uint32_t* bufferCountOutput, char* buffer, Dispatch&& d) const {
    Result result = static_cast<Result>( d.xrGetVulkanDeviceExtensionsKHR(this->get(), systemId, bufferCapacityInput, bufferCountOutput, buffer) );
    return result;
}
#ifndef OPENXR_HPP_DISABLE_ENHANCED_MODE
template <typename Allocator, typename Dispatch>
OPENXR_HPP_INLINE typename ResultValueType<std::basic_string<char, std::char_traits<char>, Allocator>>::type Instance::getVulkanDeviceExtensionsKHR (
    XrSystemId systemId, Dispatch&& d) const {
    // Two-call idiom
    std::vector<char, Allocator> buffer;
            uint32_t bufferCountOutput = 0;
    ...
    if (!unqualifiedSuccess(result) || bufferCountOutput == 0) {
        ...
        return createResultValue(result,str, OPENXR_HPP_NAMESPACE_STRING "::Instance::getVulkanDeviceExtensionsKHR");
    }
    do {
        buffer.resize(bufferCountOutput);
        bufferCapacityInput = static_cast<uint32_t>(buffer.size());
        result = static_cast<Result>( d.xrGetVulkanDeviceExtensionsKHR(this->get(), systemId, bufferCapacityInput, &bufferCountOutput, buffer.data()) );
    } while (result == xr::Result::ErrorSizeInsufficient);
    if (result == xr::Result::Success) {
        OPENXR_HPP_ASSERT(bufferCountOutput <= buffer.size());
        buffer.resize(bufferCountOutput);
...
OPENXR_HPP_INLINE ResultValueType<void>::type Instance::getVulkanGraphicsDeviceKHR (
    XrSystemId systemId, VkInstance vkInstance, VkPhysicalDevice* vkPhysicalDevice, Dispatch&& d) const {
    Result result = static_cast<Result>( d.xrGetVulkanGraphicsDeviceKHR(this->get(), systemId, vkInstance, vkPhysicalDevice) );
    return createResultValue(result, OPENXR_HPP_NAMESPACE_STRING "::Instance::getVulkanGraphicsDeviceKHR");
}
#endif /*OPENXR_HPP_DISABLE_ENHANCED_MODE*/
...
OPENXR_HPP_INLINE ResultValueType<void>::type Instance::getVulkanGraphicsRequirementsKHR (
    XrSystemId systemId, XrGraphicsRequirementsVulkanKHR* graphicsRequirements, Dispatch&& d) const {
    Result result = static_cast<Result>( d.xrGetVulkanGraphicsRequirementsKHR(this->get(), systemId, graphicsRequirements) );
    return createResultValue(result, OPENXR_HPP_NAMESPACE_STRING "::Instance::getVulkanGraphicsRequirementsKHR");
}
#endif /*OPENXR_HPP_DISABLE_ENHANCED_MODE*/
...
OPENXR_HPP_INLINE ResultValueType<void>::type Instance::getD3D11GraphicsRequirementsKHR (
    XrSystemId systemId, XrGraphicsRequirementsD3D11KHR* graphicsRequirements, Dispatch&& d) const {
    Result result = static_cast<Result>( d.xrGetD3D11GraphicsRequirementsKHR(this->get(), systemId, graphicsRequirements) );
    return createResultValue(result, OPENXR_HPP_NAMESPACE_STRING "::Instance::getD3D11GraphicsRequirementsKHR");
}
#endif /*OPENXR_HPP_DISABLE_ENHANCED_MODE*/
...
OPENXR_HPP_INLINE ResultValueType<void>::type Instance::getD3D12GraphicsRequirementsKHR (
    XrSystemId systemId, XrGraphicsRequirementsD3D12KHR* graphicsRequirements, Dispatch&& d) const {
    Result result = static_cast<Result>( d.xrGetD3D12GraphicsRequirementsKHR(this->get(), systemId, graphicsRequirements) );
    return createResultValue(result, OPENXR_HPP_NAMESPACE_STRING "::Instance::getD3D12GraphicsRequirementsKHR");
}
#endif /*OPENXR_HPP_DISABLE_ENHANCED_MODE*/
...
OPENXR_HPP_INLINE Result Session::getVisibilityMaskKHR (
    ViewConfigurationType viewConfigurationType, uint32_t viewIndex, VisibilityMaskTypeKHR visibilityMaskType, XrVisibilityMaskKHR* visibilityMask, Dispatch&& d) const {
    Result result = static_cast<Result>( d.xrGetVisibilityMaskKHR(this->get(), OPENXR_HPP_NAMESPACE::get(viewConfigurationType), viewIndex, OPENXR_HPP_NAMESPACE::get(visibilityMaskType), visibilityMask) );
    return createResultValue(result, OPENXR_HPP_NAMESPACE_STRING "::Session::getVisibilityMaskKHR", {Result::Success, Result::SessionLossPending});
}
#endif /*OPENXR_HPP_DISABLE_ENHANCED_MODE*/
...
OPENXR_HPP_INLINE ResultValueType<void>::type Instance::convertWin32PerformanceCounterToTimeKHR (
    const LARGE_INTEGER* performanceCounter, XrTime* time, Dispatch&& d) const {
    Result result = static_cast<Result>( d.xrConvertWin32PerformanceCounterToTimeKHR(this->get(), performanceCounter, time) );
    return createResultValue(result, OPENXR_HPP_NAMESPACE_STRING "::Instance::convertWin32PerformanceCounterToTimeKHR");
}
#endif /*OPENXR_HPP_DISABLE_ENHANCED_MODE*/
...
OPENXR_HPP_INLINE ResultValueType<void>::type Instance::convertTimeToWin32PerformanceCounterKHR (
    XrTime time, LARGE_INTEGER* performanceCounter, Dispatch&& d) const {
    Result result = static_cast<Result>( d.xrConvertTimeToWin32PerformanceCounterKHR(this->get(), time, performanceCounter) );
    return createResultValue(result, OPENXR_HPP_NAMESPACE_STRING "::Instance::convertTimeToWin32PerformanceCounterKHR");
}
#endif /*OPENXR_HPP_DISABLE_ENHANCED_MODE*/
...
OPENXR_HPP_INLINE ResultValueType<void>::type Instance::convertTimespecTimeToTimeKHR (
    const struct timespec* timespecTime, XrTime* time, Dispatch&& d) const {
    Result result = static_cast<Result>( d.xrConvertTimespecTimeToTimeKHR(this->get(), timespecTime, time) );
    return createResultValue(result, OPENXR_HPP_NAMESPACE_STRING "::Instance::convertTimespecTimeToTimeKHR");
}
#endif /*OPENXR_HPP_DISABLE_ENHANCED_MODE*/
...
OPENXR_HPP_INLINE ResultValueType<void>::type Instance::convertTimeToTimespecTimeKHR (
    XrTime time, struct timespec* timespecTime, Dispatch&& d) const {
    Result result = static_cast<Result>( d.xrConvertTimeToTimespecTimeKHR(this->get(), time, timespecTime) );
    return createResultValue(result, OPENXR_HPP_NAMESPACE_STRING "::Instance::convertTimeToTimespecTimeKHR");
}
#endif /*OPENXR_HPP_DISABLE_ENHANCED_MODE*/
...
OPENXR_HPP_INLINE Result Session::perfSettingsSetPerformanceLevelEXT (
    PerfSettingsDomainEXT domain, PerfSettingsLevelEXT level, Dispatch&& d) const {
    Result result = static_cast<Result>( d.xrPerfSettingsSetPerformanceLevelEXT(this->get(), OPENXR_HPP_NAMESPACE::get(domain), OPENXR_HPP_NAMESPACE::get(level)) );
    return createResultValue(result, OPENXR_HPP_NAMESPACE_STRING "::Session::perfSettingsSetPerformanceLevelEXT", {Result::Success, Result::SessionLossPending});
}
#endif /*OPENXR_HPP_DISABLE_ENHANCED_MODE*/
...
OPENXR_HPP_INLINE Result Session::thermalGetTemperatureTrendEXT (
    ...
    Result result = static_cast<Result>( d.xrThermalGetTemperatureTrendEXT(this->get(), OPENXR_HPP_NAMESPACE::get(domain), notificationLevel_tmp, tempHeadroom, tempSlope) );
    notificationLevel = static_cast<PerfSettingsNotificationLevelEXT>(notificationLevel_tmp);
    return createResultValue(result, OPENXR_HPP_NAMESPACE_STRING "::Session::thermalGetTemperatureTrendEXT", {Result::Success, Result::SessionLossPending});
}
#endif /*OPENXR_HPP_DISABLE_ENHANCED_MODE*/
...
OPENXR_HPP_INLINE ResultValueType<void>::type Instance::setDebugUtilsObjectNameEXT (
    const XrDebugUtilsObjectNameInfoEXT* nameInfo, Dispatch&& d) const {
    Result result = static_cast<Result>( d.xrSetDebugUtilsObjectNameEXT(this->get(), nameInfo) );
    return createResultValue(result, OPENXR_HPP_NAMESPACE_STRING "::Instance::setDebugUtilsObjectNameEXT");
}
#endif /*OPENXR_HPP_DISABLE_ENHANCED_MODE*/
...
OPENXR_HPP_INLINE typename ResultValueType<DebugUtilsMessengerEXT>::type Instance::createDebugUtilsMessengerEXT (
    ...
    return createResultValue(result,handle, OPENXR_HPP_NAMESPACE_STRING "::Instance::createDebugUtilsMessengerEXT");
}
#ifndef OPENXR_HPP_NO_SMART_HANDLE
...
OPENXR_HPP_INLINE typename ResultValueType<UniqueHandle<DebugUtilsMessengerEXT, impl::RemoveRefConst<Dispatch>>>::type Instance::createDebugUtilsMessengerUniqueEXT (
    ...
    Result result = static_cast<Result>( d.xrCreateDebugUtilsMessengerEXT(this->get(), createInfo, handle.put()) );
    ObjectDestroy<impl::RemoveRefConst<Dispatch>> deleter{d};
    return createResultValue<DebugUtilsMessengerEXT,impl::RemoveRefConst<Dispatch>>(result,handle,deleter, OPENXR_HPP_NAMESPACE_STRING "::Instance::createDebugUtilsMessengerUniqueEXT");
}
...
OPENXR_HPP_INLINE ResultValueType<void>::type DebugUtilsMessengerEXT::destroy (
    Dispatch&& d) const {
    Result result = static_cast<Result>( d.xrDestroyDebugUtilsMessengerEXT(this->get()) );
    return createResultValue(result, OPENXR_HPP_NAMESPACE_STRING "::DebugUtilsMessengerEXT::destroy");
}
#endif /*OPENXR_HPP_DISABLE_ENHANCED_MODE*/
...
OPENXR_HPP_INLINE ResultValueType<void>::type Instance::submitDebugUtilsMessageEXT (
    XrDebugUtilsMessageSeverityFlagsEXT messageSeverity, XrDebugUtilsMessageTypeFlagsEXT messageTypes, const XrDebugUtilsMessengerCallbackDataEXT* callbackData, Dispatch&& d) const {
    Result result = static_cast<Result>( d.xrSubmitDebugUtilsMessageEXT(this->get(), messageSeverity, messageTypes, callbackData) );
    return createResultValue(result, OPENXR_HPP_NAMESPACE_STRING "::Instance::submitDebugUtilsMessageEXT");
}
#endif /*OPENXR_HPP_DISABLE_ENHANCED_MODE*/
...
OPENXR_HPP_INLINE Result Session::sessionBeginDebugUtilsLabelRegionEXT (
    const XrDebugUtilsLabelEXT* labelInfo, Dispatch&& d) const {
    Result result = static_cast<Result>( d.xrSessionBeginDebugUtilsLabelRegionEXT(this->get(), labelInfo) );
    return createResultValue(result, OPENXR_HPP_NAMESPACE_STRING "::Session::sessionBeginDebugUtilsLabelRegionEXT", {Result::Success, Result::SessionLossPending});
}
#endif /*OPENXR_HPP_DISABLE_ENHANCED_MODE*/
...
OPENXR_HPP_INLINE Result Session::sessionEndDebugUtilsLabelRegionEXT (
    Dispatch&& d) const {
    Result result = static_cast<Result>( d.xrSessionEndDebugUtilsLabelRegionEXT(this->get()) );
    return createResultValue(result, OPENXR_HPP_NAMESPACE_STRING "::Session::sessionEndDebugUtilsLabelRegionEXT", {Result::Success, Result::SessionLossPending});
}
#endif /*OPENXR_HPP_DISABLE_ENHANCED_MODE*/
...
OPENXR_HPP_INLINE Result Session::sessionInsertDebugUtilsLabelEXT (
    const XrDebugUtilsLabelEXT* labelInfo, Dispatch&& d) const {
    Result result = static_cast<Result>( d.xrSessionInsertDebugUtilsLabelEXT(this->get(), labelInfo) );
    return createResultValue(result, OPENXR_HPP_NAMESPACE_STRING "::Session::sessionInsertDebugUtilsLabelEXT", {Result::Success, Result::SessionLossPending});
}
#endif /*OPENXR_HPP_DISABLE_ENHANCED_MODE*/
...
OPENXR_HPP_INLINE ResultValue<SpatialAnchorMSFT> Session::createSpatialAnchorMSFT (
    ...
    return createResultValue(result,handle, OPENXR_HPP_NAMESPACE_STRING "::Session::createSpatialAnchorMSFT", {Result::Success, Result::SessionLossPending});
}
#ifndef OPENXR_HPP_NO_SMART_HANDLE
...
OPENXR_HPP_INLINE ResultValue<UniqueHandle<SpatialAnchorMSFT, impl::RemoveRefConst<Dispatch>>> Session::createSpatialAnchorUniqueMSFT (
    ...
    Result result = static_cast<Result>( d.xrCreateSpatialAnchorMSFT(this->get(), createInfo, handle.put()) );
    ObjectDestroy<impl::RemoveRefConst<Dispatch>> deleter{d};
    return createResultValue<SpatialAnchorMSFT,impl::RemoveRefConst<Dispatch>>(result,handle,deleter, OPENXR_HPP_NAMESPACE_STRING "::Session::createSpatialAnchorUniqueMSFT", {Result::Success, Result::SessionLossPending});
}
...
OPENXR_HPP_INLINE ResultValue<Space> Session::createSpatialAnchorSpaceMSFT (
    ...
    return createResultValue(result,handle, OPENXR_HPP_NAMESPACE_STRING "::Session::createSpatialAnchorSpaceMSFT", {Result::Success, Result::SessionLossPending});
}
#ifndef OPENXR_HPP_NO_SMART_HANDLE
...
OPENXR_HPP_INLINE ResultValue<UniqueHandle<Space, impl::RemoveRefConst<Dispatch>>> Session::createSpatialAnchorSpaceUniqueMSFT (
    ...
    Result result = static_cast<Result>( d.xrCreateSpatialAnchorSpaceMSFT(this->get(), createInfo, handle.put()) );
    ObjectDestroy<impl::RemoveRefConst<Dispatch>> deleter{d};
    return createResultValue<Space,impl::RemoveRefConst<Dispatch>>(result,handle,deleter, OPENXR_HPP_NAMESPACE_STRING "::Session::createSpatialAnchorSpaceUniqueMSFT", {Result::Success, Result::SessionLossPending});
}
...
OPENXR_HPP_INLINE ResultValueType<void>::type SpatialAnchorMSFT::destroy (
    Dispatch&& d) const {
    Result result = static_cast<Result>( d.xrDestroySpatialAnchorMSFT(this->get()) );
    return createResultValue(result, OPENXR_HPP_NAMESPACE_STRING "::SpatialAnchorMSFT::destroy");
}
#endif /*OPENXR_HPP_DISABLE_ENHANCED_MODE*/
