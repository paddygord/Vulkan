...
public:
    ...
    vkx::vertex::Layout vertexLayout {{ 
		...
		vkx::vertex::VERTEX_COMPONENT_DUMMY_FLOAT
		});
	...
	*/
        void createStorageImage() {
            ...
            vk::CommandBuffer cmdBuffer = vulkanDevice->createCommandBuffer(VK_COMMAND_BUFFER_LEVEL_PRIMARY, true);
	...
	*/
        void createBottomLevelAccelerationStructure(const vk::GeometryNV* geometries) {
            ...
            memoryAllocateInfo.memoryTypeIndex =
                vulkanDevice->getMemoryType(memoryRequirements2.memoryRequirements.memoryTypeBits, VK_MEMORY_PROPERTY_DEVICE_LOCAL_BIT);
	...
	*/
        void createScene() {
            ...
            vkx::model::ModelCreateInfo modelCI{};
            ...
            scene.loadFromFile(context, getAssetPath() + "models/vulkanscene_shadow.dae", vertexLayout, &modelCI);
		...
		*/
            ...
            VK_CHECK_RESULT(vulkanDevice->createBuffer(VK_BUFFER_USAGE_RAY_TRACING_BIT_NV,
                                                       VK_MEMORY_PROPERTY_HOST_VISIBLE_BIT | VK_MEMORY_PROPERTY_HOST_COHERENT_BIT, &instanceBuffer,
                                                       sizeof(GeometryInstance) * geometryInstances.size(), geometryInstances.data()));
		...
		*/
            ...
            vk::MemoryRequirements2 memReqBottomLevelAS;
            memoryRequirementsInfo.accelerationStructure = bottomLevelAS.accelerationStructure;
            ...
            const vk::DeviceSize scratchBufferSize = std::max(memReqBottomLevelAS.memoryRequirements.size, memReqTopLevelAS.memoryRequirements.size);

            vks::Buffer scratchBuffer;
            VK_CHECK_RESULT(
                vulkanDevice->createBuffer(VK_BUFFER_USAGE_RAY_TRACING_BIT_NV, VK_MEMORY_PROPERTY_DEVICE_LOCAL_BIT, &scratchBuffer, scratchBufferSize));
		...
		*/
            ...
            vkCmdBuildAccelerationStructureNV(cmdBuffer, &buildInfo, VK_NULL_HANDLE, 0, VK_FALSE, bottomLevelAS.accelerationStructure, VK_NULL_HANDLE,
                                              scratchBuffer.buffer, 0);

            vk::MemoryBarrier memoryBarrier;
            memoryBarrier.srcAccessMask = VK_ACCESS_ACCELERATION_STRUCTURE_WRITE_BIT_NV | VK_ACCESS_ACCELERATION_STRUCTURE_READ_BIT_NV;
            memoryBarrier.dstAccessMask = VK_ACCESS_ACCELERATION_STRUCTURE_WRITE_BIT_NV | VK_ACCESS_ACCELERATION_STRUCTURE_READ_BIT_NV;
            vkCmdPipelineBarrier(cmdBuffer, VK_PIPELINE_STAGE_ACCELERATION_STRUCTURE_BUILD_BIT_NV, VK_PIPELINE_STAGE_ACCELERATION_STRUCTURE_BUILD_BIT_NV, 0, 1,
		...
		*/
            ...
            vkCmdBuildAccelerationStructureNV(cmdBuffer, &buildInfo, instanceBuffer.buffer, 0, VK_FALSE, topLevelAS.accelerationStructure, VK_NULL_HANDLE,
                                              scratchBuffer.buffer, 0);
        ...
        vk::DeviceSize copyShaderIdentifier(uint8_t * data, const uint8_t* shaderHandleStorage, uint32_t groupIndex) {
	...
	*/
        void createShaderBindingTable() {
            ...
            VK_CHECK_RESULT(vulkanDevice->createBuffer(VK_BUFFER_USAGE_RAY_TRACING_BIT_NV, VK_MEMORY_PROPERTY_HOST_VISIBLE_BIT, &shaderBindingTable, sbtSize));
	...
	*/
        void createDescriptorSets() {
            std::vector<vk::DescriptorPoolSize> poolSizes = { { vk::DescriptorType::eACCELERATION_STRUCTURE_NV, 1 },
                                                              { vk::DescriptorType::eSTORAGE_IMAGE, 1 },
                                                              { vk::DescriptorType::eUniformBuffer, 1 },
                                                              { vk::DescriptorType::eStorageBuffer, 2 } };
            vk::DescriptorPoolCreateInfo descriptorPoolCreateInfo{ poolSizes, 1 };
            VK_CHECK_RESULT(vkCreateDescriptorPool(device, &descriptorPoolCreateInfo, nullptr, &descriptorPool));

            vk::DescriptorSetAllocateInfo descriptorSetAllocateInfo{ descriptorPool, &descriptorSetLayout, 1 };
            ...
            accelerationStructureWrite.descriptorType = vk::DescriptorType::eACCELERATION_STRUCTURE_NV;
            ...
            vk::WriteDescriptorSet resultImageWrite{ descriptorSet, vk::DescriptorType::eSTORAGE_IMAGE, 1, &storageImageDescriptor };
            vk::WriteDescriptorSet uniformBufferWrite{ descriptorSet, vk::DescriptorType::eUniformBuffer, 2, &ubo.descriptor };
            vk::WriteDescriptorSet vertexBufferWrite{ descriptorSet, vk::DescriptorType::eStorageBuffer, 3, &vertexBufferDescriptor };
            vk::WriteDescriptorSet indexBufferWrite{ descriptorSet, vk::DescriptorType::eStorageBuffer, 4, &indexBufferDescriptor };

            std::vector<vk::WriteDescriptorSet> writeDescriptorSets = { accelerationStructureWrite, resultImageWrite, uniformBufferWrite, vertexBufferWrite,
                                                                        indexBufferWrite };
	...
	*/
        void createRayTracingPipeline() {
            ...
            accelerationStructureLayoutBinding.descriptorType = vk::DescriptorType::eACCELERATION_STRUCTURE_NV;
            accelerationStructureLayoutBinding.descriptorCount = 1;
            accelerationStructureLayoutBinding.stageFlags = vk::ShaderStageFlagBits::eRAYGEN_NV | vk::ShaderStageFlagBits::eCLOSEST_HIT_NV;

            vk::DescriptorSetLayoutBinding resultImageLayoutBinding{};
            resultImageLayoutBinding.binding = 1;
            resultImageLayoutBinding.descriptorType = vk::DescriptorType::eSTORAGE_IMAGE;
            resultImageLayoutBinding.descriptorCount = 1;
            resultImageLayoutBinding.stageFlags = vk::ShaderStageFlagBits::eRAYGEN_NV;
            ...
            uniformBufferBinding.stageFlags = vk::ShaderStageFlagBits::eRAYGEN_NV | vk::ShaderStageFlagBits::eCLOSEST_HIT_NV;
            ...
            vertexBufferBinding.stageFlags = vk::ShaderStageFlagBits::eCLOSEST_HIT_NV;
            ...
            indexBufferBinding.stageFlags = vk::ShaderStageFlagBits::eCLOSEST_HIT_NV;

            std::vector<vk::DescriptorSetLayoutBinding> bindings(
                { accelerationStructureLayoutBinding, resultImageLayoutBinding, uniformBufferBinding, vertexBufferBinding, indexBufferBinding });
            ...
            shaderStages[shaderIndexRaygen] =
                loadShader(getAssetPath() + "shaders/nv_ray_tracing_shadows/raygen.rgen.spv", vk::ShaderStageFlagBits::eRAYGEN_NV);
            shaderStages[shaderIndexMiss] = loadShader(getAssetPath() + "shaders/nv_ray_tracing_shadows/miss.rmiss.spv", vk::ShaderStageFlagBits::eMISS_NV);
            shaderStages[shaderIndexShadowMiss] =
                loadShader(getAssetPath() + "shaders/nv_ray_tracing_shadows/shadow.rmiss.spv", vk::ShaderStageFlagBits::eMISS_NV);
            shaderStages[shaderIndexClosestHit] =
                loadShader(getAssetPath() + "shaders/nv_ray_tracing_shadows/closesthit.rchit.spv", vk::ShaderStageFlagBits::eCLOSEST_HIT_NV);

            /*
			Setup ray tracing shader groups
		*/
            std::array<vk::RayTracingShaderGroupCreateInfoNV, NUM_SHADER_GROUPS> groups{};
	...
	*/
        void createUniformBuffer() {
            VK_CHECK_RESULT(vulkanDevice->createBuffer(VK_BUFFER_USAGE_UNIFORM_BUFFER_BIT,
                                                       VK_MEMORY_PROPERTY_HOST_VISIBLE_BIT | VK_MEMORY_PROPERTY_HOST_COHERENT_BIT, &ubo, sizeof(uniformData),
                                                       &uniformData));
	...
	*/
        void buildCommandBuffers() {
            ...
            vk::ImageSubresourceRange subresourceRange = { VK_IMAGE_ASPECT_COLOR_BIT, 0, 1, 0, 1 };
			...
			*/
                ...
                vk::DeviceSize bindingOffsetRayGenShader = rayTracingProperties.shaderGroupHandleSize * INDEX_RAYGEN;
                vk::DeviceSize bindingOffsetMissShader = rayTracingProperties.shaderGroupHandleSize * INDEX_MISS;
                vk::DeviceSize bindingOffsetHitShader = rayTracingProperties.shaderGroupHandleSize * INDEX_CLOSEST_HIT;
                vk::DeviceSize bindingStride = rayTracingProperties.shaderGroupHandleSize;

                vkCmdTraceRaysNV(drawCmdBuffers[i], shaderBindingTable.buffer, bindingOffsetRayGenShader, shaderBindingTable.buffer, bindingOffsetMissShader,
                                 bindingStride, shaderBindingTable.buffer, bindingOffsetHitShader, bindingStride, VK_NULL_HANDLE, 0, 0, width, height, 1);
			...
			*/
                ...
                vks::tools::setImageLayout(drawCmdBuffers[i], swapChain.images[i], VK_IMAGE_LAYOUT_UNDEFINED, VK_IMAGE_LAYOUT_TRANSFER_DST_OPTIMAL,
                                           subresourceRange);

                // Prepare ray tracing output image as transfer source
                vks::tools::setImageLayout(drawCmdBuffers[i], storageImage.image, VK_IMAGE_LAYOUT_GENERAL, VK_IMAGE_LAYOUT_TRANSFER_SRC_OPTIMAL,
                                           subresourceRange);
                ...
                vkCmdCopyImage(drawCmdBuffers[i], storageImage.image, VK_IMAGE_LAYOUT_TRANSFER_SRC_OPTIMAL, swapChain.images[i],
                               VK_IMAGE_LAYOUT_TRANSFER_DST_OPTIMAL, 1, &copyRegion);

                // Transition swap chain image back for presentation
                vks::tools::setImageLayout(drawCmdBuffers[i], swapChain.images[i], VK_IMAGE_LAYOUT_TRANSFER_DST_OPTIMAL, VK_IMAGE_LAYOUT_PRESENT_SRC_KHR,
                                           subresourceRange);

                // Transition ray tracing output image back to general layout
                vks::tools::setImageLayout(drawCmdBuffers[i], storageImage.image, VK_IMAGE_LAYOUT_TRANSFER_SRC_OPTIMAL, VK_IMAGE_LAYOUT_GENERAL,
                                           subresourceRange);
        ...
        void updateUniformBuffers() {
            ...
            uniformData.lightPos = glm::vec4(cos(glm::radians(timer * 360.0f)) * 40.0f, -50.0f + sin(glm::radians(timer * 360.0f)) * 20.0f,
        ...
        void prepare() {
            ...
            vkCreateAccelerationStructureNV =
                reinterpret_cast<PFN_vkCreateAccelerationStructureNV>(vkGetDeviceProcAddr(device, "vkCreateAccelerationStructureNV"));
            vkDestroyAccelerationStructureNV =
                reinterpret_cast<PFN_vkDestroyAccelerationStructureNV>(vkGetDeviceProcAddr(device, "vkDestroyAccelerationStructureNV"));
            vkBindAccelerationStructureMemoryNV =
                reinterpret_cast<PFN_vkBindAccelerationStructureMemoryNV>(vkGetDeviceProcAddr(device, "vkBindAccelerationStructureMemoryNV"));
            vkGetAccelerationStructureHandleNV =
                reinterpret_cast<PFN_vkGetAccelerationStructureHandleNV>(vkGetDeviceProcAddr(device, "vkGetAccelerationStructureHandleNV"));
            ...
            vkCmdBuildAccelerationStructureNV =
                reinterpret_cast<PFN_vkCmdBuildAccelerationStructureNV>(vkGetDeviceProcAddr(device, "vkCmdBuildAccelerationStructureNV"));
            ...
            vkGetRayTracingShaderGroupHandlesNV =
                reinterpret_cast<PFN_vkGetRayTracingShaderGroupHandlesNV>(vkGetDeviceProcAddr(device, "vkGetRayTracingShaderGroupHandlesNV"));
