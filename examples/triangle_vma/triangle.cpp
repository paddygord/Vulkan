...
public:
    ...
    void prepareVertices(bool useStagingBuffers) {
        ...
        // Vertex buffer
        {
            ...
            const auto& rawVertexBufferInfo = vertexBufferInfo.operator const vk::BufferCreateInfo&();
            vk::Buffer rawBuffer;
        ...
        // Index buffer
        {
            ...
            VmaAllocationCreateInfo allocInfo = {};
            allocInfo.usage = VMA_MEMORY_USAGE_CPU_TO_GPU;
            const auto& rawVertexBufferInfo = indexbufferInfo.operator const vk::BufferCreateInfo&();
            vk::Buffer rawBuffer;
    ...
    void prepareUniformBuffers() {
        ...
        VmaAllocationCreateInfo allocInfo = {};
        allocInfo.usage = VMA_MEMORY_USAGE_CPU_TO_GPU;
        const auto& rawVertexBufferInfo = bufferInfo.operator const vk::BufferCreateInfo&();
        vk::Buffer rawBuffer;
