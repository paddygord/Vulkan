...
public:
    ...
    struct Textures {
        ...
        // Object texture maps
        vkx::texture::Texture2D albedoMap;
        vkx::texture::Texture2D normalMap;
        vkx::texture::Texture2D aoMap;
        vkx::texture::Texture2D metallicMap;
        vkx::texture::Texture2D roughnessMap;
    } textures;
    ...
    void setupDescriptors() {
        // Descriptor Pool
        std::vector<vk::DescriptorPoolSize> poolSizes = { { vk::DescriptorType::eUniformBuffer, 4 }, { vk::DescriptorType::eCombinedImageSampler, 16 } };
        ...
        std::vector<vk::DescriptorSetLayoutBinding> setLayoutBindings = {
            ...
            { vk::DescriptorType::eCombinedImageSampler, vk::ShaderStageFlagBits::eFragment, 5 },
            { vk::DescriptorType::eCombinedImageSampler, vk::ShaderStageFlagBits::eFragment, 6 },
            { vk::DescriptorType::eCombinedImageSampler, vk::ShaderStageFlagBits::eFragment, 7 },
            { vk::DescriptorType::eCombinedImageSampler, vk::ShaderStageFlagBits::eFragment, 8 },
            { vk::DescriptorType::eCombinedImageSampler, vk::ShaderStageFlagBits::eFragment, 9 },
        };
        ...
        std::vector<vk::WriteDescriptorSet> writeDescriptorSets = {
            ...
            { descriptorSets.object, vk::DescriptorType::eCombinedImageSampler, 5, &textures.albedoMap.descriptor },
            { descriptorSets.object, vk::DescriptorType::eCombinedImageSampler, 6, &textures.normalMap.descriptor },
            { descriptorSets.object, vk::DescriptorType::eCombinedImageSampler, 7, &textures.aoMap.descriptor },
            { descriptorSets.object, vk::DescriptorType::eCombinedImageSampler, 8, &textures.metallicMap.descriptor },
            { descriptorSets.object, vk::DescriptorType::eCombinedImageSampler, 9, &textures.roughnessMap.descriptor },
        };
