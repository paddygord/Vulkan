...
#define SINGLE_ROW 1
    ...
    void loadAssets() {
        ...
        textures.environmentCube.loadFromFile(context, getAssetPath() + "textures/hdr/pisa_cube.ktx", vk::Format::eR16G16B16A16sFloat);
    }

    void setupDescriptors() {
        // Descriptor Pool
        std::vector<vk::DescriptorPoolSize> poolSizes = { { vk::DescriptorType::eUniformBuffer, 4 }, { vk::DescriptorType::eCombinedImageSampler, 6 } };
        ...
        std::vector<vk::DescriptorSetLayoutBinding> setLayoutBindings = {
            ...
            { vk::DescriptorType::eCombinedImageSampler, vk::ShaderStageFlagBits::eFragment, 3 },
            { vk::DescriptorType::eCombinedImageSampler, vk::ShaderStageFlagBits::eFragment, 4 },
        };
        ...
        std::vector<vk::WriteDescriptorSet> writeDescriptorSets = {
            { descriptorSets.object, vk::DescriptorType::eUniformBuffer, 0, &uniformBuffers.object.descriptor },
            { descriptorSets.object, vk::DescriptorType::eUniformBuffer, 1, &uniformBuffers.params.descriptor },
            { descriptorSets.object, vk::DescriptorType::eCombinedImageSampler, 2, &textures.irradianceCube.descriptor },
            { descriptorSets.object, vk::DescriptorType::eCombinedImageSampler, 3, &textures.lutBrdf.descriptor },
            { descriptorSets.object, vk::DescriptorType::eCombinedImageSampler, 4, &textures.prefilteredCube.descriptor },
        };
        ...
        writeDescriptorSets = {
            { descriptorSets.skybox, vk::DescriptorType::eUniformBuffer, 0, &uniformBuffers.skybox.descriptor },
            { descriptorSets.skybox, vk::DescriptorType::eUniformBuffer, 1, &uniformBuffers.params.descriptor },
            { descriptorSets.skybox, vk::DescriptorType::eCombinedImageSampler, 2, &textures.environmentCube.descriptor },
        };
        vkUpdateDescriptorSets(device, static_cast<uint32_t>(writeDescriptorSets.size()), writeDescriptorSets.data(), 0, NULL);
    }
    ...
    void preparePipelines() {
        ...
        std::vector<vk::VertexInputAttributeDescription> vertexInputAttributes = {
            ...
            { 0, 2, vk::Format::eR32G32sFloat, sizeof(float) * 6 },     // UV
        };
        ...
        shaderStages[0] = loadShader(getAssetPath() + "shaders/pbribl/skybox.vert.spv", vk::ShaderStageFlagBits::eVertex);
        shaderStages[1] = loadShader(getAssetPath() + "shaders/pbribl/skybox.frag.spv", vk::ShaderStageFlagBits::eFragment);
        VK_CHECK_RESULT(vkCreateGraphicsPipelines(device, pipelineCache, 1, &pipelineCreateInfo, nullptr, &pipelines.skybox));

        // PBR pipeline
        shaderStages[0] = loadShader(getAssetPath() + "shaders/pbribl/pbribl.vert.spv", vk::ShaderStageFlagBits::eVertex);
        shaderStages[1] = loadShader(getAssetPath() + "shaders/pbribl/pbribl.frag.spv", vk::ShaderStageFlagBits::eFragment);
    ...
    void generateBRDFLUT() {
        ...
        vk::DescriptorSetLayout descriptorsetlayout;
        std::vector<vk::DescriptorSetLayoutBinding> setLayoutBindings = {};
        vk::DescriptorSetLayoutCreateInfo descriptorsetlayoutCI{ setLayoutBindings };
        VK_CHECK_RESULT(vkCreateDescriptorSetLayout(device, &descriptorsetlayoutCI, nullptr, &descriptorsetlayout));

        // Descriptor Pool
        std::vector<vk::DescriptorPoolSize> poolSizes = { { vk::DescriptorType::eCombinedImageSampler, 1 } };
        vk::DescriptorPoolCreateInfo descriptorPoolCI{ poolSizes, 2 };
        ...
        vk::GraphicsPipelineCreateInfo pipelineCI{ pipelinelayout, renderpass };
        ...
        shaderStages[0] = loadShader(getAssetPath() + "shaders/pbribl/genbrdflut.vert.spv", vk::ShaderStageFlagBits::eVertex);
        shaderStages[1] = loadShader(getAssetPath() + "shaders/pbribl/genbrdflut.frag.spv", vk::ShaderStageFlagBits::eFragment);
        ...
        vk::CommandBuffer cmdBuf = vulkanDevice->createCommandBuffer(VK_COMMAND_BUFFER_LEVEL_PRIMARY, true);
        vkCmdBeginRenderPass(cmdBuf, &renderPassBeginInfo, VK_SUBPASS_CONTENTS_INLINE);
        vk::Viewport viewport{ (float)dim, (float)dim, 0.0f, 1.0f };
        vk::Rect2D scissor{ dim, dim, 0, 0 };
    ...
    void generateIrradianceCube() {
        ...
        vk::DescriptorSetAllocateInfo allocInfo{ descriptorpool, &descriptorsetlayout, 1 };
        VK_CHECK_RESULT(vkAllocateDescriptorSets(device, &allocInfo, &descriptorset));
        vk::WriteDescriptorSet writeDescriptorSet{ descriptorset, vk::DescriptorType::eCombinedImageSampler, 0, &textures.environmentCube.descriptor };
        ...
        vk::PipelineLayout pipelinelayout;
        std::vector<vk::PushConstantRange> pushConstantRanges = {
            { vk::ShaderStageFlagBits::eVertex | vk::ShaderStageFlagBits::eFragment, sizeof(PushBlock), 0 },
        };
        vk::PipelineLayoutCreateInfo pipelineLayoutCI{ &descriptorsetlayout, 1 };
        ...
        vk::VertexInputAttributeDescription vertexInputAttribute{ 0, 0, vk::Format::eR32G32B32sFloat, 0 };
        ...
        shaderStages[0] = loadShader(getAssetPath() + "shaders/pbribl/filtercube.vert.spv", vk::ShaderStageFlagBits::eVertex);
        shaderStages[1] = loadShader(getAssetPath() + "shaders/pbribl/irradiancecube.frag.spv", vk::ShaderStageFlagBits::eFragment);
        vk::Pipeline pipeline;
        VK_CHECK_RESULT(vkCreateGraphicsPipelines(device, pipelineCache, 1, &pipelineCI, nullptr, &pipeline));
        ...
        vks::tools::setImageLayout(cmdBuf, textures.irradianceCube.image, VK_IMAGE_LAYOUT_UNDEFINED, VK_IMAGE_LAYOUT_TRANSFER_DST_OPTIMAL, subresourceRange);
        ...
        for (uint32_t m = 0; m < numMips; m++) {
            for (uint32_t f = 0; f < 6; f++) {
                ...
                vkCmdPushConstants(cmdBuf, pipelinelayout, vk::ShaderStageFlagBits::eVertex | vk::ShaderStageFlagBits::eFragment, 0, sizeof(PushBlock),
                                   &pushBlock);
                ...
                vks::tools::setImageLayout(cmdBuf, offscreen.image, VK_IMAGE_ASPECT_COLOR_BIT, VK_IMAGE_LAYOUT_COLOR_ATTACHMENT_OPTIMAL,
        ...
        vks::tools::setImageLayout(cmdBuf, textures.irradianceCube.image, VK_IMAGE_LAYOUT_TRANSFER_DST_OPTIMAL, VK_IMAGE_LAYOUT_SHADER_READ_ONLY_OPTIMAL,
                                   subresourceRange);
    ...
    void generatePrefilteredCube() {
        ...
        shaderStages[0] = loadShader(getAssetPath() + "shaders/pbribl/filtercube.vert.spv", vk::ShaderStageFlagBits::eVertex);
        shaderStages[1] = loadShader(getAssetPath() + "shaders/pbribl/prefilterenvmap.frag.spv", vk::ShaderStageFlagBits::eFragment);
        vk::Pipeline pipeline;
        VK_CHECK_RESULT(vkCreateGraphicsPipelines(device, pipelineCache, 1, &pipelineCI, nullptr, &pipeline));
        ...
        // Change image layout for all cubemap faces to transfer destination
        vks::tools::setImageLayout(cmdBuf, textures.prefilteredCube.image, VK_IMAGE_LAYOUT_UNDEFINED, VK_IMAGE_LAYOUT_TRANSFER_DST_OPTIMAL, subresourceRange);
        ...
        vks::tools::setImageLayout(cmdBuf, textures.prefilteredCube.image, VK_IMAGE_LAYOUT_TRANSFER_DST_OPTIMAL, VK_IMAGE_LAYOUT_SHADER_READ_ONLY_OPTIMAL,
                                   subresourceRange);
