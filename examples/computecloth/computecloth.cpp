...
public:
    ...
    void buildComputeCommandBuffer() {
        for (uint32_t i = 0; i < 2; i++) {
            ...
            bufferBarriers.push_back(bufferBarrier);
            commandBuffer.pipelineBarrier(vk::PipelineStageFlagBits::eComputeShader, vk::PipelineStageFlagBits::eComputeShader, vk::DependencyFlags{}, nullptr,
            ...
            for (uint32_t j = 0; j < iterations; j++) {
                ...
                commandBuffer.pipelineBarrier(vk::PipelineStageFlagBits::eComputeShader, vk::PipelineStageFlagBits::eComputeShader, vk::DependencyFlags{},
    ...
    void prepareCompute() {
        ...
        compute.fence = device.createFence(vk::FenceCreateInfo{ vk::FenceCreateFlagBits::eSignaled });
