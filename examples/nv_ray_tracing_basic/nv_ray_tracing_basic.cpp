...
public:
	...
	*/
    void createScene() {
		...
		*/
        ...
        VK_CHECK_RESULT(vulkanDevice->createBuffer(VK_BUFFER_USAGE_RAY_TRACING_BIT_NV, VK_MEMORY_PROPERTY_DEVICE_LOCAL_BIT, &scratchBuffer, scratchBufferSize));
	...
	*/
    void createDescriptorSets() {
        ...
        std::vector<vk::WriteDescriptorSet> writeDescriptorSets = { accelerationStructureWrite, resultImageWrite, uniformBufferWrite };
	...
	*/
    void createRayTracingPipeline() {
        ...
        accelerationStructureLayoutBinding.stageFlags = vk::ShaderStageFlagBits::eRAYGEN_NV;
        ...
        uniformBufferBinding.stageFlags = vk::ShaderStageFlagBits::eRAYGEN_NV;

        std::vector<vk::DescriptorSetLayoutBinding> bindings({ accelerationStructureLayoutBinding, resultImageLayoutBinding, uniformBufferBinding });
        ...
        shaderStages[shaderIndexRaygen] = loadShader(getAssetPath() + "shaders/nv_ray_tracing_basic/raygen.rgen.spv", vk::ShaderStageFlagBits::eRAYGEN_NV);
        shaderStages[shaderIndexMiss] = loadShader(getAssetPath() + "shaders/nv_ray_tracing_basic/miss.rmiss.spv", vk::ShaderStageFlagBits::eMISS_NV);
        shaderStages[shaderIndexClosestHit] =
            loadShader(getAssetPath() + "shaders/nv_ray_tracing_basic/closesthit.rchit.spv", vk::ShaderStageFlagBits::eCLOSEST_HIT_NV);
	...
	*/
    ...
    void prepare() {
        ...
        vkGetAccelerationStructureMemoryRequirementsNV =
            reinterpret_cast<PFN_vkGetAccelerationStructureMemoryRequirementsNV>(vkGetDeviceProcAddr(device, "vkGetAccelerationStructureMemoryRequirementsNV"));
