...
public:
    ...
    void loadAssets() {
        ...
        cubes[0].texture.loadFromFile(context, getAssetPath() + "textures/crate01_color_height_rgba.ktx", vk::Format::eR8G8B8A8Unorm);
        cubes[1].texture.loadFromFile(context, getAssetPath() + "textures/crate02_color_height_rgba.ktx", vk::Format::eR8G8B8A8Unorm);
    }
	...
	*/
    void setupDescriptors() {
		...
		*/
        setLayoutBindings[1].descriptorType = vk::DescriptorType::eCombinedImageSampler;
        setLayoutBindings[1].binding = 1;
        // Accessible from the fragment shader only
        setLayoutBindings[1].stageFlags = vk::ShaderStageFlagBits::eFragment;
		...
		*/
        ...
        for (auto& cube : cubes) {
			...
			*/
            ...
            // This is possible because each vk::WriteDescriptorSet also contains the destination set to be updated
    ...
    void preparePipelines() {
		...
		*/
        ...
        const std::array<vk::PipelineShaderStageCreateInfo, 2> shaderStages = {
            loadShader(getAssetPath() + "shaders/descriptorsets/cube.vert.spv", vk::ShaderStageFlagBits::eVertex),
            loadShader(getAssetPath() + "shaders/descriptorsets/cube.frag.spv", vk::ShaderStageFlagBits::eFragment)
        };
    ...
    void prepareUniformBuffers() {
        ...
        for (auto& cube : cubes) {
            VK_CHECK_RESULT(vulkanDevice->createBuffer(VK_BUFFER_USAGE_UNIFORM_BUFFER_BIT,
                                                       VK_MEMORY_PROPERTY_HOST_VISIBLE_BIT | VK_MEMORY_PROPERTY_HOST_COHERENT_BIT, &cube.uniformBuffer,
