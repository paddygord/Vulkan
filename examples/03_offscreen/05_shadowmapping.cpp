...
#undef QUAD_COLOR_NORMAL
    ...
    void updateTexture() {
        ...
        offscreen.cmdBuffer.copyImage(offscreenFrameBuf.depth.image, vk::ImageLayout::eTransferSrcOptimal, offscreenFrameBuf.textureTarget.image, vk::ImageLayout::eTransferDstOptimal, imgCopy);
