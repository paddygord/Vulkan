...
public:
    ...
    void preparePipelines() {
        ...
        pipelines.models = device.createGraphicsPipelines(context.pipelineCache, pipelineCreateInfo, nullptr)[0];
        ...
        pipelines.logos = device.createGraphicsPipelines(context.pipelineCache, pipelineCreateInfo, nullptr)[0];
