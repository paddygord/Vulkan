...
public:
    ...
    void preparePipelines() {
        ...
        shaderStages[0] = loadShader(getAssetPath() + "shaders/tardisconsole/mesh.vert.spv", vk::ShaderStageFlagBits::eVertex);
        shaderStages[1] = loadShader(getAssetPath() + "shaders/tardisconsole/mesh.frag.spv", vk::ShaderStageFlagBits::eFragment);
