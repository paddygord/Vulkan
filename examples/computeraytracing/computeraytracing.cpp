...
public:
    ...
    void prepareStorageBuffers() {
        ...
        vulkanDevice->createBuffer(VK_BUFFER_USAGE_TRANSFER_SRC_BIT, VK_MEMORY_PROPERTY_HOST_VISIBLE_BIT | VK_MEMORY_PROPERTY_HOST_COHERENT_BIT, &stagingBuffer,
                                   storageBufferSize, spheres.data());
        ...
        vulkanDevice->createBuffer(
            ...
            &compute.storageBuffers.spheres, storageBufferSize);
    ...
    void setupDescriptorPool() {
        std::vector<vk::DescriptorPoolSize> poolSizes = {
            { vk::DescriptorType::eUniformBuffer, 2 },         // Compute UBO
            { vk::DescriptorType::eCombinedImageSampler, 4 },  // Graphics image samplers
            { vk::DescriptorType::eSTORAGE_IMAGE, 1 },         // Storage image for ray traced image output
            { vk::DescriptorType::eStorageBuffer, 2 },         // Storage buffer for the scene primitives
        };
    ...
    void setupDescriptorSetLayout() {
        std::vector<vk::DescriptorSetLayoutBinding> setLayoutBindings = {
            ...
            vk::descriptorSetLayoutBinding{vk::DescriptorType::eCombinedImageSampler, vk::ShaderStageFlagBits::eFragment, 0}
        };
        ...
        vk::PipelineLayoutCreateInfo pPipelineLayoutCreateInfo = vk::pipelineLayoutCreateInfo{&graphics.descriptorSetLayout, 1};
    ...
    void setupDescriptorSet() {
        ...
        std::vector<vk::WriteDescriptorSet> writeDescriptorSets = {
            ...
            vk::writeDescriptorSet{graphics.descriptorSet, vk::DescriptorType::eCombinedImageSampler, 0, &textureComputeTarget.descriptor}
        };
    ...
    void preparePipelines() {
        ...
        vk::PipelineRasterizationStateCreateInfo rasterizationState =
            vk::pipelineRasterizationStateCreateInfo{VK_POLYGON_MODE_FILL, VK_CULL_MODE_FRONT_BIT, VK_FRONT_FACE_COUNTER_CLOCKWISE, 0};
        ...
        shaderStages[0] = loadShader(getAssetPath() + "shaders/computeraytracing/texture.vert.spv", vk::ShaderStageFlagBits::eVertex);
        shaderStages[1] = loadShader(getAssetPath() + "shaders/computeraytracing/texture.frag.spv", vk::ShaderStageFlagBits::eFragment);
    ...
    void prepareCompute() {
        ...
        std::vector<vk::DescriptorSetLayoutBinding> setLayoutBindings = {
            ...
            vk::descriptorSetLayoutBinding{vk::DescriptorType::eSTORAGE_IMAGE, vk::ShaderStageFlagBits::eCOMPUTE, 0},
            ...
            vk::descriptorSetLayoutBinding{vk::DescriptorType::eStorageBuffer, vk::ShaderStageFlagBits::eCOMPUTE, 2},
            // Binding 1: Shader storage buffer for the planes
            vk::descriptorSetLayoutBinding{vk::DescriptorType::eStorageBuffer, vk::ShaderStageFlagBits::eCOMPUTE, 3}
        };
        ...
        std::vector<vk::WriteDescriptorSet> computeWriteDescriptorSets = {
            ...
            vk::writeDescriptorSet{compute.descriptorSet, vk::DescriptorType::eSTORAGE_IMAGE, 0, &textureComputeTarget.descriptor},
            // Binding 1: Uniform buffer block
            ...
            vk::writeDescriptorSet{compute.descriptorSet, vk::DescriptorType::eStorageBuffer, 2, &compute.storageBuffers.spheres.descriptor},
            // Binding 2: Shader storage buffer for the planes
            vk::writeDescriptorSet{compute.descriptorSet, vk::DescriptorType::eStorageBuffer, 3, &compute.storageBuffers.planes.descriptor}
        };

        vkUpdateDescriptorSets(device, computeWriteDescriptorSets.size(), computeWriteDescriptorSets.data(), 0, NULL);

        // Create compute shader pipelines
        vk::ComputePipelineCreateInfo computePipelineCreateInfo = vk::computePipelineCreateInfo{compute.pipelineLayout, 0};

        computePipelineCreateInfo.stage = loadShader(getAssetPath() + "shaders/computeraytracing/raytracing.comp.spv", vk::ShaderStageFlagBits::eCOMPUTE);
