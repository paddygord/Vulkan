...
static VKAPI_ATTR vk::Bool32 VKAPI_CALL debugMessageCallback(vk::DebugReportFlagsEXT flags,
...
public:
    ...
    vk::Result createBuffer(vk::BufferUsageFlags usageFlags,
        ...
        vk::BufferCreateInfo bufferCreateInfo{ usageFlags, size };
    ...
    VulkanExample() {
...
#if defined(VK_USE_PLATFORM_ANDROID_KHR)
        const char* validationLayers[] = { "VK_LAYER_GOOGLE_threading",      "VK_LAYER_LUNARG_parameter_validation",
		...
		*/
        ...
        vk::Buffer deviceBuffer, hostBuffer;
        vk::DeviceMemory deviceMemory, hostMemory;

        // Copy input data to VRAM using a staging buffer
        {
            createBuffer(VK_BUFFER_USAGE_TRANSFER_SRC_BIT | VK_BUFFER_USAGE_TRANSFER_DST_BIT, VK_MEMORY_PROPERTY_HOST_VISIBLE_BIT, &hostBuffer, &hostMemory,
                         bufferSize, computeInput.data());
            ...
            createBuffer(VK_BUFFER_USAGE_STORAGE_BUFFER_BIT | VK_BUFFER_USAGE_TRANSFER_SRC_BIT | VK_BUFFER_USAGE_TRANSFER_DST_BIT,
                         VK_MEMORY_PROPERTY_DEVICE_LOCAL_BIT, &deviceBuffer, &deviceMemory, bufferSize);

            // Copy to staging buffer
            vk::CommandBufferAllocateInfo cmdBufAllocateInfo{ commandPool, VK_COMMAND_BUFFER_LEVEL_PRIMARY, 1 };
            ...
            vk::FenceCreateInfo fenceInfo{ VK_FLAGS_NONE };
            vk::Fence fence;
		...
		*/
        {
            ...
            std::vector<vk::DescriptorSetLayoutBinding> setLayoutBindings = {
                { vk::DescriptorType::eStorageBuffer, vk::ShaderStageFlagBits::eCOMPUTE, 0 },
            };
            ...
            vk::DescriptorBufferInfo bufferDescriptor = { deviceBuffer, 0, VK_WHOLE_SIZE };
            std::vector<vk::WriteDescriptorSet> computeWriteDescriptorSets = {
                { descriptorSet, vk::DescriptorType::eStorageBuffer, 0, &bufferDescriptor },
            };
            ...
            // Create pipeline
            vk::ComputePipelineCreateInfo computePipelineCreateInfo{ pipelineLayout, 0 };
		...
		*/
        {
            ...
            vkCmdPipelineBarrier(commandBuffer, VK_PIPELINE_STAGE_HOST_BIT, VK_PIPELINE_STAGE_COMPUTE_SHADER_BIT, VK_FLAGS_NONE, 0, nullptr, 1, &bufferBarrier,
                                 0, nullptr);
            ...
            vkCmdPipelineBarrier(commandBuffer, VK_PIPELINE_STAGE_COMPUTE_SHADER_BIT, VK_PIPELINE_STAGE_TRANSFER_BIT, VK_FLAGS_NONE, 0, nullptr, 1,
            ...
            vkCmdPipelineBarrier(commandBuffer, VK_PIPELINE_STAGE_TRANSFER_BIT, VK_PIPELINE_STAGE_HOST_BIT, VK_FLAGS_NONE, 0, nullptr, 1, &bufferBarrier, 0,
                                 nullptr);
            ...
            const vk::PipelineStageFlags waitStageMask = VK_PIPELINE_STAGE_TRANSFER_BIT;
