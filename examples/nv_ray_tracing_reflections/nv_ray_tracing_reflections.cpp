...
public:
	...
	*/
        void createScene() {
            ...
            scene.loadFromFile(context, getAssetPath() + "models/reflection_test.dae", vertexLayout, &modelCI);
		...
		*/
            ...
            VK_CHECK_RESULT(vulkanDevice->createBuffer(VK_BUFFER_USAGE_RAY_TRACING_BIT_NV,
                                                       ...
                                                       sizeof(GeometryInstance), &geometryInstance));
	...
	*/
        void createRayTracingPipeline() {
            ...
            uniformBufferBinding.stageFlags =
                vk::ShaderStageFlagBits::eRAYGEN_NV | vk::ShaderStageFlagBits::eCLOSEST_HIT_NV | vk::ShaderStageFlagBits::eMISS_NV;
            ...
            shaderStages[shaderIndexRaygen] =
                loadShader(getAssetPath() + "shaders/nv_ray_tracing_reflections/raygen.rgen.spv", vk::ShaderStageFlagBits::eRAYGEN_NV);
            shaderStages[shaderIndexMiss] = loadShader(getAssetPath() + "shaders/nv_ray_tracing_reflections/miss.rmiss.spv", vk::ShaderStageFlagBits::eMISS_NV);
            shaderStages[shaderIndexClosestHit] =
                loadShader(getAssetPath() + "shaders/nv_ray_tracing_reflections/closesthit.rchit.spv", vk::ShaderStageFlagBits::eCLOSEST_HIT_NV);
            ...
            vk::SpecializationInfo specializationInfo{ 1, &specializationMapEntry, sizeof(maxRecursion), &maxRecursion };
	...
	*/
        ...
        void updateUniformBuffers() {
            ...
            uniformData.lightPos = glm::vec4(cos(glm::radians(timer * 360.0f)) * 40.0f, -20.0f + sin(glm::radians(timer * 360.0f)) * 20.0f,
