...
public:
	...
	*/
    void submitWork(vk::CommandBuffer cmdBuffer, vk::Queue queue) {
    ...
    VulkanExample() {
		...
		*/
        ...
        };
        {
            ...
            const vk::DeviceSize vertexBufferSize = vertices.size() * sizeof(Vertex);
            const vk::DeviceSize indexBufferSize = indices.size() * sizeof(uint32_t);
            ...
            {
                // Vertices
                createBuffer(VK_BUFFER_USAGE_TRANSFER_SRC_BIT, VK_MEMORY_PROPERTY_HOST_VISIBLE_BIT | VK_MEMORY_PROPERTY_HOST_COHERENT_BIT, &stagingBuffer,
                             &stagingMemory, vertexBufferSize, vertices.data());

                createBuffer(VK_BUFFER_USAGE_VERTEX_BUFFER_BIT | VK_BUFFER_USAGE_TRANSFER_DST_BIT, VK_MEMORY_PROPERTY_DEVICE_LOCAL_BIT, &vertexBuffer,
                ...
                // Indices
                createBuffer(VK_BUFFER_USAGE_TRANSFER_SRC_BIT, VK_MEMORY_PROPERTY_HOST_VISIBLE_BIT | VK_MEMORY_PROPERTY_HOST_COHERENT_BIT, &stagingBuffer,
                             &stagingMemory, indexBufferSize, indices.data());

                createBuffer(VK_BUFFER_USAGE_INDEX_BUFFER_BIT | VK_BUFFER_USAGE_TRANSFER_DST_BIT, VK_MEMORY_PROPERTY_DEVICE_LOCAL_BIT, &indexBuffer,
		...
		*/
        {
            ...
            vk::PipelineLayoutCreateInfo pipelineLayoutCreateInfo = { nullptr, 0 };
            ...
            std::vector<vk::VertexInputAttributeDescription> vertexInputAttributes = {
                ...
                { 0, 1, vk::Format::eR32G32B32sFloat, sizeof(float) * 3 },  // Color
            };
		...
		*/
        {
            ...
            for (auto v : pos) {
                ...
                vkCmdPushConstants(commandBuffer, pipelineLayout, vk::ShaderStageFlagBits::eVertex, 0, sizeof(mvpMatrix), &mvpMatrix);
		...
		*/
			...
			const bool colorSwizzle = (std::find(formatsBGR.begin(), formatsBGR.end(), vk::Format::eR8G8B8A8Unorm) != formatsBGR.end());
