...
public:
    ...
    void prepareResources() {
        ...
        vk::CommandBufferAllocateInfo cmdBufAllocateInfo =
            vkx::commandBufferAllocateInfo(commandPool, vk::CommandBufferLevel::ePrimary, (uint32_t)cmdBuffers.size());
        ...
        vk::BufferCreateInfo bufferInfo = vkx::bufferCreateInfo(vk::BufferUsageFlagBits::eVertexBuffer, bufferSize);
        ...
        vk::DescriptorImageInfo texDescriptor =
            vkx::descriptorImageInfo(sampler, view, vk::ImageLayout::eGeneral);
    ...
    void preparePipeline() {
        vk::PipelineInputAssemblyStateCreateInfo inputAssemblyState =
            vkx::pipelineInputAssemblyStateCreateInfo(vk::PrimitiveTopology::eTriangleStrip, vk::PipelineInputAssemblyStateCreateFlags(), VK_FALSE);
...
public:
    ...
    void prepareUniformBuffers() {
        ...
        uniformData.vsScene = createBuffer(vk::BufferUsageFlagBits::eUniformBuffer, sizeof(uboVS), &uboVS);
