...
public:
    ...
    void buildCommandBuffers() {
        ...
        for (int32_t i = 0; i < drawCmdBuffers.size(); ++i) {
            ...
            for (auto cube : cubes) {
                ...
                writeDescriptorSets[1].descriptorType = vk::DescriptorType::eUniformBuffer;
                ...
                writeDescriptorSets[2].descriptorType = vk::DescriptorType::eCombinedImageSampler;
    ...
    void setupDescriptorSetLayout() {
        std::vector<vk::DescriptorSetLayoutBinding> setLayoutBindings = {
            ...
            { vk::DescriptorType::eUniformBuffer, vk::ShaderStageFlagBits::eVertex, 1 },
    ...
    void preparePipelines() {
        ...
        const std::array<vk::PipelineShaderStageCreateInfo, 2> shaderStages = {
            loadShader(getAssetPath() + "shaders/pushdescriptors/cube.vert.spv", vk::ShaderStageFlagBits::eVertex),
            loadShader(getAssetPath() + "shaders/pushdescriptors/cube.frag.spv", vk::ShaderStageFlagBits::eFragment)
        };
