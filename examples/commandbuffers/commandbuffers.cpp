...
public:
    ...
    void setupDescriptors() {
        ...
        std::vector<vk::DescriptorPoolSize> poolSizes = {
            { vk::DescriptorType::eUniformBuffer, 1 + static_cast<uint32_t>(swapChain.imageCount) },
        };
        vk::DescriptorPoolCreateInfo descriptorPoolInfo = { poolSizes.size(), poolSizes.data(), 1 + static_cast<uint32_t>(swapChain.imageCount) };
        ...
        vk::PushConstantRange pushConstantRange{ vk::ShaderStageFlagBits::eVertex, sizeof(pushConstants), 0 };
        ...
        vk::WriteDescriptorSet writeDescriptorSet = { singleCB.descriptorSet, vk::DescriptorType::eUniformBuffer, 0, &singleCB.uniformBuffer.descriptor };
        ...
        for (auto i = 0; i < multiCB.descriptorSets.size(); i++) {
            ...
            vk::WriteDescriptorSet writeDescriptorSet = { multiCB.descriptorSets[i], vk::DescriptorType::eUniformBuffer, 0,
                                                          &multiCB.uniformBuffers[i].descriptor };
            vkUpdateDescriptorSets(device, 1, &writeDescriptorSet, 0, nullptr);
        }
    }
    ...
    void preparePipelines() {
        ...
        std::vector<vk::VertexInputBindingDescription> vertexInputBindings = { { 0, vertexLayout.stride( },
        ...
        std::vector<vk::VertexInputAttributeDescription> vertexInputAttributes = {
            ...
            { 0, 2, vk::Format::eR32G32sFloat, sizeof(float) * 6 },     // Location 3 : UV
            { 0, 3, vk::Format::eR32G32B32sFloat, sizeof(float) * 8 }   // Location 3 : Cp�pr
        };
        ...
        std::array<vk::PipelineShaderStageCreateInfo, 2> shaderStages = {
            loadShader(getAssetPath() + "shaders/pushconstants/lights.vert.spv", vk::ShaderStageFlagBits::eVertex),
            loadShader(getAssetPath() + "shaders/pushconstants/lights.frag.spv", vk::ShaderStageFlagBits::eFragment)
        };
    ...
    void prepare() {
		...
		*/
        ...
        vk::CommandBufferAllocateInfo cmdBufAllocateInfo{ singleCB.commandPool, VK_COMMAND_BUFFER_LEVEL_PRIMARY, 1 };
		...
		*/
        ...
        // Command buffers
        {
            vk::CommandBufferAllocateInfo cmdBufAllocateInfo =
                vks::initializers::commandBufferAllocateInfo(multiCB.commandPool, VK_COMMAND_BUFFER_LEVEL_PRIMARY,
	...
	*/
    void recordCommandBuffer() {
        ...
        vkCmdPushConstants(currentCB, pipelineLayout, vk::ShaderStageFlagBits::eVertex, 0, sizeof(pushConstants), pushConstants.data());
