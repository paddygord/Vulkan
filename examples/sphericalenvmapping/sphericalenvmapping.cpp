...
public:
    ...
    void preparePipelines() {
        ...
        shaderStages[0] = context.loadShader(getAssetPath() + "shaders/sphericalenvmapping/sem.vert.spv", vk::ShaderStageFlagBits::eVertex);
        shaderStages[1] = context.loadShader(getAssetPath() + "shaders/sphericalenvmapping/sem.frag.spv", vk::ShaderStageFlagBits::eFragment);
        ...
        pipelines.sem = device.createGraphicsPipelines(context.pipelineCache, pipelineCreateInfo, nullptr)[0];
    }
